...
import expertConsultationController from '../controllers/ai/expert-consultation.controller';
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/start', expertConsultationController.startConsultation);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/:sessionId/next', expertConsultationController.getNextExpertSpeech);
 ...
 *               type: string
 */
router.get('/:sessionId/stream-speech', authMiddleware, expertConsultationController.getExpertSpeechStream);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/:sessionId/progress', expertConsultationController.getConsultationProgress);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/:sessionId/summary', expertConsultationController.getConsultationSummary);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/:sessionId/action-plan', expertConsultationController.generateActionPlan);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/:sessionId', expertConsultationController.getConsultationSession);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/user/history', expertConsultationController.getUserConsultations);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/experts/types', expertConsultationController.getExpertTypes);
