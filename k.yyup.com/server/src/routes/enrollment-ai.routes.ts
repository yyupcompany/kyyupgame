...
import { EnrollmentAIController } from '../controllers/enrollment-ai.controller';
...
const enrollmentAIController = new EnrollmentAIController();
...
router.get(
  '/ai-status',
  enrollmentAIController.checkAIStatus.bind(enrollmentAIController)
);
...
// 全局趋势分析
router.get(
  '/trends', checkPermission('ENROLLMENT_PLAN_MANAGE'),
  enrollmentAIController.generateTrendAnalysis.bind(enrollmentAIController)
);
...
// 针对特定招生计划的AI功能
router.post(
  '/plan/:id/smart-planning', checkPermission('ENROLLMENT_PLAN_MANAGE'),
  enrollmentAIController.generateSmartPlanning.bind(enrollmentAIController)
);
...
*/
router.post(
  '/plan/:id/forecast', checkPermission('ENROLLMENT_PLAN_MANAGE'),
  enrollmentAIController.generateForecast.bind(enrollmentAIController)
);
...
*/
router.post(
  '/plan/:id/strategy', checkPermission('ENROLLMENT_PLAN_MANAGE'),
  enrollmentAIController.generateStrategy.bind(enrollmentAIController)
);
...
*/
router.post(
  '/plan/:id/optimization', checkPermission('ENROLLMENT_PLAN_MANAGE'),
  enrollmentAIController.generateOptimization.bind(enrollmentAIController)
);
...
*/
router.post(
  '/plan/:id/simulation', checkPermission('ENROLLMENT_PLAN_MANAGE'),
  enrollmentAIController.generateSimulation.bind(enrollmentAIController)
);
...
*/
router.post(
  '/plan/:id/evaluation', checkPermission('ENROLLMENT_PLAN_MANAGE'),
  enrollmentAIController.generateEvaluation.bind(enrollmentAIController)
);
...
// AI分析历史和批量操作
router.get(
  '/plan/:id/ai-history', checkPermission('ENROLLMENT_PLAN_MANAGE'),
  enrollmentAIController.getAIAnalysisHistory.bind(enrollmentAIController)
);
...
*/
router.post(
  '/plan/:id/batch-analysis', checkPermission('ENROLLMENT_PLAN_MANAGE'),
  enrollmentAIController.batchAnalysis.bind(enrollmentAIController)
);
...
*/
router.get(
  '/plan/:id/export-ai-report', checkPermission('ENROLLMENT_PLAN_MANAGE'),
  enrollmentAIController.exportAIReport.bind(enrollmentAIController)
);
