 ...
 */
router.get(
  '/stats', checkPermission('ADVERTISEMENT_MANAGE'),
  getAllAdvertisementStatistics
);
 ...
 */
router.get(
  '/by-type/:type', checkPermission('ADVERTISEMENT_MANAGE'),
  getAdvertisementsByType
);
 ...
 */
router.get(
  '/by-status/:status', checkPermission('ADVERTISEMENT_MANAGE'),
  getAdvertisementsByStatus
);
 ...
 */
router.get(
  '/', checkPermission('ADVERTISEMENT_MANAGE'),
  getAdvertisements
);
 ...
 */
router.get(
  '/:id/statistics', checkPermission('ADVERTISEMENT_MANAGE'),
  getAdvertisementStatistics
);
 ...
 */
router.post(
  '/:id/pause', checkPermission('ADVERTISEMENT_MANAGE'),
  pauseAdvertisement
);
 ...
 */
router.post(
  '/:id/resume', checkPermission('ADVERTISEMENT_MANAGE'),
  resumeAdvertisement
);
 ...
 */
router.get(
  '/:id', checkPermission('ADVERTISEMENT_MANAGE'),
  getAdvertisement
);
