...
import { 
  ...
  deleteElement,
  getCategories
} from '../controllers/poster-template.controller';
 ...
 */
router.put(
  '/:id', checkPermission('POSTER_TEMPLATE_MANAGE'),
  updateTemplate
);
 ...
 */
router.get(
  '/:id/preview', checkPermission('POSTER_TEMPLATE_MANAGE'),
  previewTemplate
);
 ...
 */
router.post(
  '/:id/elements', checkPermission('POSTER_TEMPLATE_MANAGE'),
  addElement
);
 ...
 */
router.put(
  '/:id/elements/:elementId', checkPermission('POSTER_TEMPLATE_MANAGE'),
  updateElement
);
