 ...
 *               $ref: '#/components/schemas/ErrorResponse'
*/
router.post('/critical', ErrorsController.reportCriticalError);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
*/
router.post('/report', ErrorsController.reportErrorBatch);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
*/
router.get('/statistics', ErrorsController.getErrorStatistics);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
*/
router.get('/health', ErrorsController.healthCheck);
