 ...
 *         $ref: '#/components/responses/InternalServerError'
*/
router.post('/', checkPermission('kindergarten:manage'), KindergartenController.create);
// 幼儿园列表接口 - 支持管理员查看所有，家长查看基础信息
router.get('/', checkPermission('kindergarten:view'), KindergartenController.list);
 ...
 *         $ref: '#/components/responses/InternalServerError'
*/
router.get('/:id', checkPermission('kindergarten:manage'), KindergartenController.getById);
 ...
 *         $ref: '#/components/responses/InternalServerError'
*/
router.put('/:id', checkPermission('kindergarten:manage'), KindergartenController.update);
 ...
 *         $ref: '#/components/responses/InternalServerError'
*/
router.delete('/:id', checkPermission('kindergarten:manage'), KindergartenController.delete);
