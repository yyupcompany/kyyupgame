...
import { EnrollmentStatisticsController } from '../controllers/enrollment-statistics.controller';
...
const enrollmentStatisticsController = new EnrollmentStatisticsController();
...
*/
router.get(
  '/', checkPermission('ENROLLMENT_STATISTICS_MANAGE'),
  enrollmentStatisticsController.getStatistics
);
...
*/
router.get(
  '/trend', checkPermission('ENROLLMENT_STATISTICS_MANAGE'),
  enrollmentStatisticsController.getTrend
);
...
*/
router.get(
  '/channel', checkPermission('ENROLLMENT_STATISTICS_MANAGE'),
  enrollmentStatisticsController.getChannelAnalysis
);
 ...
 *         description: 服务器错误
*/
router.get('/plans', checkPermission('ENROLLMENT_STATISTICS_MANAGE'),
  (req, res) => {
 ...
 *         description: 服务器错误
*/
router.get('/channels', checkPermission('ENROLLMENT_STATISTICS_MANAGE'),
  (req, res) => {
 ...
 *         description: 服务器错误
*/
router.get('/activities', checkPermission('ENROLLMENT_STATISTICS_MANAGE'),
  (req, res) => {
 ...
 *         description: 服务器错误
*/
router.get('/conversions', checkPermission('ENROLLMENT_STATISTICS_MANAGE'),
  (req, res) => {
 ...
 *         description: 服务器错误
*/
router.get('/performance', checkPermission('ENROLLMENT_STATISTICS_MANAGE'),
  (req, res) => {
 ...
 *         description: 服务器错误
*/
router.get('/trends', checkPermission('ENROLLMENT_STATISTICS_MANAGE'),
  (req, res) => {
