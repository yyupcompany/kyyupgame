...
import { FileController, uploadFileMiddleware } from '../controllers/file.controller';
 ...
 *         $ref: '#/components/responses/InternalServerError'
*/
router.post('/upload', uploadFileMiddleware.single('file'), fileController.uploadFile);
 ...
 *         $ref: '#/components/responses/InternalServerError'
*/
router.post('/upload-multiple', uploadFileMiddleware.array('files', 5), fileController.uploadMultipleFiles);
 ...
 *         $ref: '#/components/responses/InternalServerError'
*/
router.post('/cleanup-temp', fileController.cleanupTempFiles);
