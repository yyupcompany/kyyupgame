...
import { MarketingCenterController } from '../controllers/marketing-center.controller';
...
const marketingCenterController = new MarketingCenterController();
 ...
 *         description: 服务器错误
*/
router.get('/statistics', marketingCenterController.getStatistics);
 ...
 *         description: 服务器错误
*/
router.get('/campaigns/recent', marketingCenterController.getRecentCampaigns);
 ...
 *         description: 服务器错误
*/
router.get('/channels', marketingCenterController.getChannels);
