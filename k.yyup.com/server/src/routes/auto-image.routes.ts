...
import {
  ...
  generateActivityImageValidation,
  generatePosterImageValidation,
  generateTemplateImageValidation,
  generateBatchImagesValidation
} from '../controllers/auto-image.controller';
...
router.post(
  ...
  AutoImageController.generateImage
);
...
router.post(
  ...
  generateActivityImageValidation,
  handleValidationErrors,
  AutoImageController.generateActivityImage
);
...
router.post(
  ...
  generatePosterImageValidation,
  handleValidationErrors,
  AutoImageController.generatePosterImage
);
...
router.post(
  ...
  generateTemplateImageValidation,
  handleValidationErrors,
  AutoImageController.generateTemplateImage
);
...
router.post(
  ...
  generateBatchImagesValidation,
  handleValidationErrors,
  AutoImageController.generateBatchImages
);
...
router.get(
  '/status',
  authMiddleware,
  AutoImageController.checkServiceStatus
);
