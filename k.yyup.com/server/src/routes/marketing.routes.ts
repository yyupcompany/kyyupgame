...
router.post('/channels', checkPermission('MARKETING_CHANNELS_MANAGE'), controller.createChannel.bind(controller));
router.put('/channels/:id', checkPermission('MARKETING_CHANNELS_MANAGE'), controller.updateChannel.bind(controller));
router.delete('/channels/:id', checkPermission('MARKETING_CHANNELS_MANAGE'), controller.deleteChannel.bind(controller));
router.get('/channels/:id/contacts', controller.getChannelContacts.bind(controller));
router.post('/channels/:id/contacts', checkPermission('MARKETING_CHANNELS_MANAGE'), controller.addChannelContact.bind(controller));
router.delete('/channels/:id/contacts/:contactId', checkPermission('MARKETING_CHANNELS_MANAGE'), controller.deleteChannelContact.bind(controller));
router.get('/channels/:id/tags', controller.getChannelTags.bind(controller));
router.post('/channels/:id/tags', checkPermission('MARKETING_CHANNELS_MANAGE'), controller.addChannelTags.bind(controller));
router.delete('/channels/:id/tags/:tagId', checkPermission('MARKETING_CHANNELS_MANAGE'), controller.deleteChannelTag.bind(controller));
