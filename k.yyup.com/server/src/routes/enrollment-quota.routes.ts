...
*/
router.get(
  '/', checkPermission('enrollment:manage'),
  (req, res) => {
    res.json({
      success: true,
      message: '获取招生名额列表成功',
...
*/
router.get(
  '/by-plan/:planId', checkPermission('enrollment:manage'),
  (req, res) => {
...
*/
router.get(
  '/by-class/:classId', checkPermission('enrollment:manage'),
  (req, res) => {
...
*/
router.get(
  '/:id', checkPermission('enrollment:manage'),
  (req, res) => {
...
router.post(
  ...
  (req, res) => {
    res.json({
      ...
      message: '名额批量调整成功',
      data: {
        adjustedCount: req.body.adjustments?.length || 0,
        adjustedAt: new Date()
      }
    });
  }
...
*/
router.patch(
  '/:id/adjust', checkPermission('enrollment:manage'),
  (req, res) => {
    const id = parseInt(req.params.id);
    res.json({
      success: true,
