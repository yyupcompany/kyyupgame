 ...
 * 创建招生咨询验证规则
 */
export const createEnrollmentConsultationSchema = Joi.object({
 ...
 * 更新招生咨询验证规则
 */
export const updateEnrollmentConsultationSchema = Joi.object({
 ...
 * 招生咨询过滤参数验证规则
 */
export const enrollmentConsultationFilterSchema = Joi.object({
 ...
 * 创建招生咨询跟进验证规则
 */
export const createEnrollmentConsultationFollowupSchema = Joi.object({
 ...
 * 招生咨询跟进过滤参数验证规则
 */
export const enrollmentConsultationFollowupFilterSchema = Joi.object({
  page: Joi.number().integer().min(1).optional().messages({
    'number.base': '页码必须是数字',
    'number.integer': '页码必须是整数',
    'number.min': '页码必须大于等于1'
