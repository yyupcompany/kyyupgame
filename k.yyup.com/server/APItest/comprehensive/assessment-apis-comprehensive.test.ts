...
describe('评估考核API严格验证', () => {
  ...
  test('GET /api/assessment - 评估列表格式标准', async () => {
  ...
  test('GET /api/performance-evaluations - 绩效考核格式标准', async () => {
  ...
  test('GET /api/performance-reports - 绩效报告格式标准', async () => {
  ...
  test('GET /api/assessment-admin - 评估管理格式标准', async () => {
    
    if (!authToken) {
      console.log('⚠️ 跳过评估管理测试：未获取到认证token');
      return;
    }
  ...
  test('GET /api/assessment-share - 评估分享格式标准', async () => {
    
    if (!authToken) {
      console.log('⚠️ 跳过评估分享测试：未获取到认证token');
      return;
    }
  ...
  describe('📊 评估考核API测试报告', () => {
    test('生成评估考核API测试覆盖报告', async () => {
      const endpoints = [
        '/api/assessment',
