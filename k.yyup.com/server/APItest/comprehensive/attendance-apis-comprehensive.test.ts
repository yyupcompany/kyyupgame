...
describe('考勤相关API严格验证', () => {
  ...
  test('GET /api/teacher-attendance - 教师考勤格式标准', async () => {
    
    if (!authToken) {
      console.log('⚠️ 跳过教师考勤测试：未获取到认证token');
      return;
    }
  ...
  test('GET /api/teacher-checkin - 教师签到格式标准', async () => {
    
    if (!authToken) {
      console.log('⚠️ 跳过教师签到测试：未获取到认证token');
      return;
    }
  ...
  test('GET /api/attendance-center - 考勤中心格式标准', async () => {
    
    if (!authToken) {
      console.log('⚠️ 跳过考勤中心测试：未获取到认证token');
      return;
    }
  ...
  describe('📊 考勤相关API测试报告', () => {
    test('生成考勤相关API测试覆盖报告', async () => {
      const endpoints = [
        '/api/teacher-attendance',
        '/api/teacher-checkin',
        '/api/attendance-center'
      ];
