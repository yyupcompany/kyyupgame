...
describe('其他杂项API严格验证', () => {
  ...
  test('GET /api/schedules - 日程安排格式标准', async () => {
    
    if (!authToken) {
      console.log('⚠️ 跳过日程安排测试：未获取到认证token');
      return;
    }
  ...
  test('GET /api/operation-logs - 操作日志格式标准', async () => {
    
    if (!authToken) {
      console.log('⚠️ 跳过操作日志测试：未获取到认证token');
      return;
    }
  ...
  test('GET /api/role-permission - 角色权限格式标准', async () => {
    
    if (!authToken) {
      console.log('⚠️ 跳过角色权限测试：未获取到认证token');
      return;
    }
  ...
  test('GET /api/statistics - 统计数据格式标准', async () => {
    
    if (!authToken) {
      console.log('⚠️ 跳过统计数据测试：未获取到认证token');
      return;
    }
  ...
  describe('📊 其他杂项API测试报告', () => {
    test('生成其他杂项API测试覆盖报告', async () => {
      const endpoints = [
        '/api/schedules',
        '/api/operation-logs',
        '/api/role-permission',
