 ...
 *         description: 服务器内部错误
 */
router.get('/', auth_middleware_1.verifyToken, (0, auth_middleware_1.checkPermission)('PRINCIPAL_PERFORMANCE'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var overview;
 ...
 *         description: 服务器内部错误
 */
router.get('/stats', auth_middleware_1.verifyToken, (0, auth_middleware_1.checkPermission)('PRINCIPAL_PERFORMANCE'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var stats;
    return __generator(this, function (_a) {
        try {
            stats = {
 ...
 *         description: 服务器内部错误
 */
router.get('/rankings', auth_middleware_1.verifyToken, (0, auth_middleware_1.checkPermission)('PRINCIPAL_PERFORMANCE'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var rankings;
    return __generator(this, function (_a) {
        try {
            rankings = [
 ...
 *         description: 服务器内部错误
 */
router.get('/details', auth_middleware_1.verifyToken, (0, auth_middleware_1.checkPermission)('PRINCIPAL_PERFORMANCE'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, principalId, period, details;
    return __generator(this, function (_b) {
        try {
            _a = req.query, principalId = _a.principalId, period = _a.period;
            details = {
 ...
 *         description: 服务器内部错误
 */
router.get('/export', auth_middleware_1.verifyToken, (0, auth_middleware_1.checkPermission)('PRINCIPAL_PERFORMANCE'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, format, period, exportData;
    return __generator(this, function (_c) {
        try {
            _a = req.query, _b = _a.format, format = _b === void 0 ? 'excel' : _b, period = _a.period;
            exportData = {
                filename: "principal_performance_".concat(period || '2024-04', ".").concat(format),
                downloadUrl: "/downloads/principal_performance_".concat(Date.now(), ".").concat(format),
                size: '2.5MB',
 ...
 *         description: 服务器内部错误
 */
router.get('/goals', auth_middleware_1.verifyToken, (0, auth_middleware_1.checkPermission)('PRINCIPAL_PERFORMANCE'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var goals;
    return __generator(this, function (_a) {
        try {
            goals = {
