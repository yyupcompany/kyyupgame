 ...
 *         description: 服务器错误
 */
router.get('/', auth_middleware_1.verifyToken, (0, auth_middleware_1.checkPermission)('PARENT_MANAGE'), parentStudentRelationController.getAllRelations);
/**
 * @swagger
 ...
 *         description: 服务器错误
 */
router.put('/:id', auth_middleware_1.verifyToken, (0, auth_middleware_1.checkPermission)('PARENT_MANAGE'), parentStudentRelationController.updateRelation);
/**
 * @swagger
 ...
 *         description: 服务器错误
 */
router.get('/parents/:id/students', auth_middleware_1.verifyToken, (0, auth_middleware_1.checkPermission)('PARENT_MANAGE'), parentStudentRelationController.getParentStudents);
/**
 * @swagger
 * /api/parent-student-relations/parents/{id}/students:
 *   post:
 ...
 *         description: 服务器错误
 */
router.post('/parents/:id/students', auth_middleware_1.verifyToken, (0, auth_middleware_1.checkPermission)('PARENT_MANAGE'), parentStudentRelationController.addParentStudent);
/**
 * @swagger
 ...
 *         description: 服务器错误
 */
router["delete"]('/parents/:parentId/students/:studentId', auth_middleware_1.verifyToken, (0, auth_middleware_1.checkPermission)('PARENT_MANAGE'), parentStudentRelationController.removeParentStudent);
/**
 * @swagger
 ...
 *         description: 服务器错误
 */
router.get('/students/:id/parents', auth_middleware_1.verifyToken, (0, auth_middleware_1.checkPermission)('PARENT_MANAGE'), parentStudentRelationController.getStudentParents);
