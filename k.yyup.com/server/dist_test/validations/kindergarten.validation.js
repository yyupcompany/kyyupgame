...
exports.updateKindergartenSchema = exports.createKindergartenSchema = void 0;
var Joi = require('joi');
// 创建幼儿园验证规则
exports.createKindergartenSchema = Joi.object({
    name: Joi.string()
        .max(100)
        .required()
        .messages({
...
// 更新幼儿园验证规则
exports.updateKindergartenSchema = Joi.object({
    name: Joi.string()
        .max(100)
        .allow('')
        .messages({
