...
exports.roleValiditySchema = exports.primaryRoleSchema = exports.roleIdsSchema = void 0;
var Joi = require('joi');
// 为用户分配角色时的验证规则
exports.roleIdsSchema = Joi.object({
...
// 设置用户主要角色的验证规则
exports.primaryRoleSchema = Joi.object({
...
// 更新角色有效期的验证规则
exports.roleValiditySchema = Joi.object({
    startTime: Joi.date().iso().allow(null)
        .messages({
        'date.base': '开始时间必须是有效的日期',
        'date.format': '开始时间格式必须是ISO'
