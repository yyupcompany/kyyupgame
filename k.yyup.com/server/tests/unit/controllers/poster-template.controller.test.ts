// Mock dependencies
jest.mock('../../../src/controllers/poster-template.controller');
jest.mock('../../../src/utils/apiError');
jest.mock('../../../src/utils/apiResponse');

import { Request, Response, NextFunction } from 'express';
import { vi } from 'vitest'
import { createTemplate } from '../../../src/controllers/poster-template.controller';
import { getTemplates } from '../../../src/controllers/poster-template.controller';
import { updateTemplate } from '../../../src/controllers/poster-template.controller';
...
describe('Poster Template Controller', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
