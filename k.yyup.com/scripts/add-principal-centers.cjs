...
async function addPrincipalCenters() {
  let connection;
  try {
    ...
    console.log('\n' + '='.repeat(70));
    console.log('�� 添加园长角色的管理层中心权限');
    console.log('='.repeat(70) + '\n');

    // 需要添加的权限ID
    const permissionsToAdd = [
      { id: 5234, name: '活动中心', path: '/centers/activity' },
      { id: 5236, name: '客户池中心', path: '/centers/customer-pool' },
      { id: 5237, name: '招生中心', path: '/centers/enrollment' },
      { id: 5238, name: '任务中心', path: '/centers/task' },
      { id: 5240, name: '教学中心', path: '/centers/teaching' }
    ];
