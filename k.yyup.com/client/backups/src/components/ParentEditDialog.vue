      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="性别" prop="gender">
            <el-select v-model="formData.gender" placeholder="选择性别" style="width: 100%">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="关系" prop="relationship">
            <el-select v-model="formData.relationship" placeholder="选择与孩子关系" style="width: 100%">
