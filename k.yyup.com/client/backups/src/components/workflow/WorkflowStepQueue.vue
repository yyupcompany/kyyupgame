    ...
    <div v-if="!isCollapsed" class="steps-container">
      ...
      >
        ...
        <div class="step-content">
          ...
          <!-- 当前步骤的详细信息 -->
          <div v-if="step.status === 'running' && step.details" class="step-details">
            {{ step.details }}
          </div>
...
.queue-header {
  ...
  align-items: center;
  padding: var(--text-lg);
  border-bottom: var(--border-width-base) solid var(--shadow-light);
  cursor: pointer;
...
.step-item {
  ...
  border-bottom: var(--border-width-base) solid var(--shadow-lighter);
...
.dark .workflow-step-queue {
  ...
  border: var(--border-width-base) solid var(--glass-bg-light);
}
