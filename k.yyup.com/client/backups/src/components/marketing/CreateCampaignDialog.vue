    ...
    >
      ...
      <el-form-item label="预算金额" prop="budget">
        <el-input-number
          ...
          style="width: 200px"
        />
        <span style="margin-left: var(--spacing-2xl)">元</span>
      </el-form-item>
        ...
        <el-row :gutter="20">
          <el-col :span="8">
            <el-input-number
              ...
              style="width: 100%"
            />
            <div style="text-align: center; margin-top: var(--spacing-base); color: var(--text-tertiary);">目标参与人数</div>
          </el-col>
          <el-col :span="8">
            <el-input-number
              ...
              style="width: 100%"
            />
            <div style="text-align: center; margin-top: var(--spacing-base); color: var(--text-tertiary);">目标转化率(%)</div>
          </el-col>
          <el-col :span="8">
            <el-input-number
              ...
              style="width: 100%"
            />
            <div style="text-align: center; margin-top: var(--spacing-base); color: var(--text-tertiary);">目标招生数</div>
          </el-col>
        </el-row>
      </el-form-item>
