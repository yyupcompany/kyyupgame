...
.app-card {
  ...
  border: var(--border-width-base) solid var(--border-color, var(--border-color));
  ...
  &--shadow-md {
    box-shadow: var(--shadow-md, 0 var(--spacing-xs) var(--text-2xl) 0 var(--shadow-medium));
  }
...
.app-card-header {
  ...
  border-bottom: var(--border-width-base) solid var(--border-color, var(--border-color));
...
.app-card-footer {
  background: var(--bg-secondary, var(--bg-gray-light));
  border-top: var(--border-width-base) solid var(--border-color, var(--border-color));
}
