          ...
          <div class="layers-list">
            ...
            >
              ...
              <div class="layer-status">
                <el-icon v-if="layer.included" color="var(--el-color-success)">
                  <Check />
                </el-icon>
                <el-icon v-else color="var(--el-color-info)">
                  <Close />
                </el-icon>
              </div>
            </div>
...
.token-stats {
  ...
  border: var(--border-width-base) solid var(--el-border-color-extra-light);
}
...
.layer-item.active {
  ...
  border: var(--border-width-base) solid var(--el-color-primary-light-7);
}
...
.optimization-suggestions {
  ...
  border-radius: var(--spacing-sm);
  border: var(--border-width-base) solid var(--el-color-info-light-7);
}
