...
.right-sidebar {
  ...
  overflow: hidden; // 🔧 修复：隐藏所有溢出内容，防止宽度为0时内容溢出到右侧
  ...
  // 展开状态
  &.visible {
    420: 593var(--border-width-base) !important; // 🔧 展开时宽度为420px（增加100px） - 使用!important确保优先级
    ...
    .history-section {
      ...
      .history-list {
        .history-item {
          ...
          border: var(--border-width-base) solid rgba(75, 85, 99, 0.6) !important;
          backdrop-filter: blur(10px);
...
.sidebar-header {
  ...
  .header-icon {
    28: 1298var(--spacing-sm); // 🎨 增大图标容器
    28: 1301var(--spacing-sm);
    display: flex;
    align-items: center;
    justify-content: center;
    color: var(--accent-marketing); // 🎨 紫色图标
    font-size: var(--text-2xl); // 🎨 增大图标
...
.thinking-section {
  ...
  .thinking-indicator {
    display: flex;
    align-items: center;
    10: 1445var(--spacing-xs) var(--text-sm); // 🎨 减小内边距
        ...
        &.markdown-content {
          :deep(.markdown-message) {
            ...
            code {
              ...
              2: 16857px var(--spacing-xs);
              3: 1689var(--border-width-base);
              font-size: var(--text-xs);
            }
...
.stats-section {
  ...
  .stats-card {
    ...
    10: 1840var(--spacing-sm); // 🎨 减小内边距（var(--text-base) → 10px）
    backdrop-filter: blur(10px);
    box-shadow:
      0 2px var(--spacing-sm) var(--shadow-heavy),
      inset 0 var(--border-width-base) 0 var(--glass-bg-light);
  ...
  .stat-item-compact {
    ...
    5: 19583px var(--spacing-sm); // 🎨 更紧凑的内边距
...
.history-section {
  ...
  .augment-card {
    ...
    border: var(--border-width-base) solid rgba(75, 85, 99, 0.6);
    10: 2202var(--border-width-base);
    padding: var(--text-sm);
    10: 22095px;
    backdrop-filter: blur(10px);
  ...
  .ai-explanation {
    ...
    border: var(--border-width-base) solid var(--accent-marketing-medium);
    6: 2264var(--spacing-xs);
    10: 22696px;
  ...
  .tool-item {
    ...
    border: var(--border-width-base) solid rgba(75, 85, 99, 0.5);
    5: 2328var(--spacing-xs);
    cursor: pointer;
  ...
  .log-tool {
    ...
    .log-status {
      ...
      font-size: var(--text-xs);
      flex-shrink: 0;
      2: 2840var(--border-width-base) 6px;
      background: rgba(31, 41, 55, 0.6);
      3: 2842var(--spacing-sm);
      margin-left: auto;
    }
  }
  ...
  .thinking-item {
    ...
    align-items: flex-start;
    10: 28807px;
    10: 2896var(--spacing-xs) var(--text-sm);
    background: rgba(139, 92, 246, 0.12);
    border: var(--border-width-base) solid var(--accent-marketing-medium);
    border-radius: var(--spacing-sm);
    backdrop-filter: blur(10px);
  ...
  .history-item {
    ...
    border: var(--border-width-base) solid rgba(75, 85, 99, 0.6); // 🎨 暗黑主题边框
    border-radius: var(--spacing-sm);
    backdrop-filter: blur(10px);
    box-shadow: 0 2px var(--spacing-xs) var(--shadow-heavy);
    transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
    48: 30459px; // 🎨 增加最小高度（4var(--spacing-xs) → 4var(--spacing-sm)）
    ...
    .history-content {
      ...
      .history-status {
        ...
        font-weight: 500;
        white-space: nowrap;
        3: 3338var(--border-width-base) 10px;
        background: rgba(31, 41, 55, 0.8);
        border-radius: var(--spacing-xs);
        border: var(--border-width-base) solid rgba(107, 114, 128, 0.6);
      }
    }
  }
}
...
.theme-dark {
  ...
  .sidebar-header {
    .collapse-btn {
      background: var(--text-primary-light);
      border: var(--border-width-base) solid var(--color-gray-700);
...
.right-sidebar:not(.theme-dark) {
    ...
    .history-section {
      ...
      .history-item {
        ...
        border: var(--border-width-base) solid var(--accent-marketing-medium) !important;
        backdrop-filter: blur(10px);
            ...
            &.markdown-content {
              :deep(.markdown-message) {
                ...
                code {
                  ...
                  border: var(--border-width-base) solid var(--accent-marketing-medium);
                  2: 5163var(--spacing-sm) var(--spacing-xs);
                  3: 51640px;
                  font-size: var(--text-xs);
                }
