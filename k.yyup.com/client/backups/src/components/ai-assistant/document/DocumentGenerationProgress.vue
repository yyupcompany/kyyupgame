  ...
  <div class="document-generation-progress">
    ...
    <div class="progress-header">
      <div class="progress-icon">
        <el-icon :size="24" class="rotating">
          <Loading />
        </el-icon>
      </div>
    ...
    <div class="progress-steps">
      ...
      >
        <div class="step-icon">
          <el-icon v-if="step.status === 'completed'" :size="16" color="var(--success-color)">
            <CircleCheck />
          </el-icon>
          <el-icon v-else-if="step.status === 'active'" :size="16" color="var(--primary-color)" class="rotating">
            <Loading />
          </el-icon>
          <el-icon v-else :size="16" color="var(--info-color)">
            <Clock />
          </el-icon>
        </div>
