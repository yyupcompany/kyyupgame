  ...
  <div class="data-statistics-container statistics-analysis-page">
    ...
    <el-row :gutter="24" class="charts-section">
      ...
      <el-col :xs="24" :lg="12">
        <div class="chart-card">
          ...
          <div class="el-card__body">
            <div ref="enrollmentChartRef" class="chart-container" v-loading="loading.enrollmentChart" style="height: 350px; min-height: 300px;"></div>
          </div>
        </div>
      </el-col>
      ...
      <el-col :xs="24" :lg="12">
        <div class="chart-card">
          ...
          <div class="el-card__body">
            <div ref="revenueChartRef" class="chart-container" v-loading="loading.revenueChart" style="height: 350px; min-height: 300px;"></div>
          </div>
        </div>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="24" class="charts-section">
      ...
      <el-col :xs="24" :lg="12">
        <div class="chart-card">
          ...
          <div class="el-card__body">
            <div ref="classDistributionChartRef" class="chart-container" v-loading="loading.classChart" style="height: 350px; min-height: 300px;"></div>
          </div>
        </div>
      </el-col>
      ...
      <el-col :xs="24" :lg="12">
        <div class="chart-card">
          ...
          <div class="el-card__body">
            <div ref="sourceAnalysisChartRef" class="chart-container" v-loading="loading.sourceChart" style="height: 350px; min-height: 300px;"></div>
          </div>
        </div>
      </el-col>
    </el-row>
    ...
    <div class="data-table-section">
      ...
      <div v-show="activeTab === 'revenue'">
        <el-table :data="revenueData" style="width: 100%" v-loading="loading.revenueTable">
      ...
      <div v-show="activeTab === 'class'">
        <el-table :data="classData" style="width: 100%" v-loading="loading.classTable">
      ...
      <div v-show="activeTab === 'teacher'">
        <el-table :data="teacherData" style="width: 100%" v-loading="loading.teacherTable">
    ...
    >
      <div v-loading="drillDownLoading" class="drill-down-content">
        <div v-if="drillDownData" class="drill-down-data">
          ...
          <el-table :data="drillDownData.details || []" stripe style="width: 100%">
            <el-table-column prop="date" label="日期" width="120" />
...
@import './data-statistics-ux-styles.scss';
