      ...
      <el-tabs v-model="activeTab" type="border-card">
        ...
        <el-tab-pane label="统计数据" name="statistics">
          <div class="statistics-section">
            ...
            <div class="kindergarten-details">
              <h3>园所详情</h3>
              <el-table :data="statistics?.kindergartenDetails" border stripe>
        ...
        <el-tab-pane label="用户管理" name="users">
          <div class="users-section">
            ...
            <el-table :data="groupUsers" border stripe>
...
function handleEditUser(row: GroupUser) {
  // TODO: 打开编辑用户对话框
  ElMessage.info('编辑用户功能开发中');
}

function handleRemoveUser(row: GroupUser) {
  // TODO: 移除用户
