    ...
    <el-card class="generate-card">
      ...
      <el-form :model="generateForm" :inline="true">
        <el-form-item label="报表类型">
          <el-select v-model="generateForm.type" placeholder="选择报表类型" style="width: 200px">
        ...
        <el-form-item label="统计周期">
          <el-select v-model="generateForm.period" placeholder="选择周期" style="width: 150px">
      ...
      <div class="report-detail">
        ...
        <div class="report-content" v-if="currentReport.data">
          ...
          <div v-if="currentReport.type === 'revenue'" class="revenue-report">
            <h3>收入明细</h3>
            <el-table :data="currentReport.data.items" border>
