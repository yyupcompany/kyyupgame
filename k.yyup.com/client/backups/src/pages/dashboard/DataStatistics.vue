<template>
  <div class="dashboard-container">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <div class="chart-container">
              <div ref="enrollmentChartRef" style="width: 100%; height: 450px;"></div>
            </div>
          </el-col>
          <el-col :span="12">
            <div class="chart-container">
              <div ref="activityChartRef" style="width: 100%; height: 450px;"></div>
            </div>
          </el-col>
        </el-row>
      </div>
    ...
    <div class="dashboard-data-section">
      ...
      <div class="data-content">
        <el-table :data="tableData" v-loading="loading.table" style="width: 100%">
...
const statCards = ref([
  { label: '学生总数', value: '1250', trend: 12.5, color: 'var(--primary-color)', icon: User },
  { label: '活动总数', value: '156', trend: 15.7, color: 'var(--success-color)', icon: User },
  { label: '教师总数', value: '85', trend: 3.2, color: 'var(--warning-color)', icon: User },
  { label: '班级总数', value: '42', trend: 8.1, color: 'var(--danger-color)', icon: User }
])
...
.data-header {
  ...
  background: var(--white-alpha-10);
  border-bottom: var(--border-width-base) solid var(--white-alpha-10);
}
