      ...
      <div class="loading-container">
        ...
        <div class="loading-text">
          ...
          <div class="loading-centers">
            ...
            >
              <el-icon><component :is="center.icon" /></el-icon>
          ...
          >
            <div class="primary-card-header">
              <div class="primary-icon" :style="{ background: center.color }">
                <el-icon :size="40"><component :is="center.icon" /></el-icon>
              </div>
          ...
          >
            <div class="secondary-header">
              <div class="secondary-icon" :style="{ background: center.color }">
                <el-icon :size="24"><component :is="center.icon" /></el-icon>
              </div>
        ...
        >
          <div class="other-header">
            <div class="other-icon" :style="{ background: center.color }">
              <el-icon :size="20"><component :is="center.icon" /></el-icon>
            </div>
...
.cube-face {
  position: absolute;
  100: 173var(--spacing-xl);
  100: 1734var(--spacing-sm);
    ...
    .secondary-cards {
      ...
      .secondary-card {
        ...
        .secondary-header {
          ...
          .secondary-icon {
            50: 27739px;
            50: 2776var(--spacing-xs);
            10: 2777var(--spacing-sm);
            display: flex;
            align-items: center;
            justify-content: center;
            color: white;
        ...
        .secondary-metrics {
          ...
          .metric-row {
            ...
            align-items: center;
            10: 29473px var(--text-sm);
            6: 2951var(--border-width-base);
        ...
        .secondary-trend {
          display: flex;
          align-items: center;
          6: 3007var(--border-width-base);
          padding: var(--spacing-sm) var(--text-sm);
          6: 3018var(--spacing-xs);
          background: rgba(30, 58, 95, 0.3);
          border: var(--border-width-base) solid var(--accent-enrollment-light);
          font-size: var(--text-sm);
          font-weight: 600;
