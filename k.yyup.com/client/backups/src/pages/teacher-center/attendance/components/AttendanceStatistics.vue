  ...
  <div class="attendance-statistics-tab">
    ...
    <div v-if="filterForm.type === 'teacher'">
      ...
      <el-card class="chart-card" shadow="never">
        ...
        <div ref="teacherTrendChart" style="height: 300px"></div>
      </el-card>
    </div>
    ...
    <div v-if="filterForm.type === 'class'">
      ...
      <el-card class="ranking-card" shadow="never">
        ...
        <el-table :data="studentRanking" border stripe>
      ...
      <el-card class="abnormal-card" shadow="never">
        ...
        <el-table :data="abnormalStudents" border stripe>
      ...
      <el-card class="chart-card" shadow="never">
        ...
        <div ref="classTrendChart" style="height: 300px"></div>
      </el-card>
    </div>
  </div>
</template>
