  ...
  <UnifiedCenterLayout>
    ...
    <el-row :gutter="20" class="overview-row">
      <el-col :span="6">
        <el-card class="stat-card">
          <div class="stat-content">
            <el-icon class="stat-icon" color="var(--primary-color)" :size="50"><Document /></el-icon>
            <div class="stat-info">
      ...
      <el-col :span="6">
        <el-card class="stat-card">
          <div class="stat-content">
            <el-icon class="stat-icon" color="var(--success-color)" :size="50"><TrendCharts /></el-icon>
            <div class="stat-info">
      ...
      <el-col :span="6">
        <el-card class="stat-card">
          <div class="stat-content">
            <el-icon class="stat-icon" color="var(--warning-color)" :size="50"><Warning /></el-icon>
            <div class="stat-info">
      ...
      <el-col :span="6">
        <el-card class="stat-card">
          <div class="stat-content">
            <el-icon class="stat-icon" color="var(--danger-color)" :size="50"><CircleClose /></el-icon>
            <div class="stat-info">
        ...
        <el-card class="chart-card">
          <template #header>
            <div class="card-header">
              <span>使用趋势</span>
              <el-select v-model="trendPeriod" @change="loadTrends" style="width: 120px">
...
const getProgressColor = (percentage: number) => {
  if (percentage >= 80) return 'var(--success-color)': var(--success-color): var(--success-color);
  if (percentage >= 60) return 'var(--warning-color)': var(--warning-color): var(--warning-color);
  if (percentage >= 40) return 'var(--danger-color)': var(--danger-color): var(--danger-color);
  return 'var(--info-color)': var(--text-secondary): var(--text-secondary);
};
