  ...
  <UnifiedCenterLayout>
    ...
    <el-row :gutter="20" class="stats-row">
      <el-col :span="6">
        <el-card class="stat-card">
          <div class="stat-content">
            <el-icon class="stat-icon" color="var(--primary-color)" :size="40"><Document /></el-icon>
            <div class="stat-info">
      ...
      <el-col :span="6">
        <el-card class="stat-card">
          <div class="stat-content">
            <el-icon class="stat-icon" color="var(--success-color)" :size="40"><Edit /></el-icon>
            <div class="stat-info">
      ...
      <el-col :span="6">
        <el-card class="stat-card">
          <div class="stat-content">
            <el-icon class="stat-icon" color="var(--warning-color)" :size="40"><Clock /></el-icon>
            <div class="stat-info">
      ...
      <el-col :span="6">
        <el-card class="stat-card">
          <div class="stat-content">
            <el-icon class="stat-icon" color="var(--danger-color)" :size="40"><Star /></el-icon>
            <div class="stat-info">
    ...
    <el-card class="filter-card">
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <el-button type="primary" size="large" @click="loadTemplates" style="width: 100%">
...
.document-template-center-timeline {
