<template>
  ...
  >
    ...
    >
      ...
      <div style="margin-top: var(--spacing-sm); font-size: var(--text-sm); line-height: 1.6;">
    ...
    >
      ...
      <div style="font-size: var(--text-sm); line-height: 1.8;">
        1. 本次分析预计需要 <strong style="color: var(--warning-color);">10分钟</strong><br>
        2. 分析过程中<strong style="color: var(--danger-color);">请勿刷新网页</strong><br>
    ...
    >
      ...
      <div style="font-size: var(--text-sm); margin-top: var(--spacing-sm);">
        ...
        <div class="document-list">
          ...
          >
            ...
            <div class="status-icon">
              <el-icon v-if="doc.status === 'pending'" class="pending-icon">
                <Clock />
              </el-icon>
              <el-icon v-else-if="doc.status === 'running'" class="running-icon is-loading">
                <Loading />
              </el-icon>
              <el-icon v-else-if="doc.status === 'completed'" class="success-icon">
                <CircleCheck />
              </el-icon>
              <el-icon v-else-if="doc.status === 'failed'" class="error-icon">
                <CircleClose />
              </el-icon>
            </div>
