    ...
    <el-row :gutter="16">
      ...
      <el-col :span="8">
        <el-card shadow="never">
          ...
          <el-table :data="abnormalData.consecutiveAbsent" max-height="400">
      ...
      <el-col :span="8">
        <el-card shadow="never">
          ...
          <el-table :data="abnormalData.frequentLate" max-height="400">
            <el-table-column prop="studentName" label="姓名" width="100" />
            <el-table-column prop="className" label="班级" width="100" />
      ...
      <el-col :span="8">
        <el-card shadow="never">
          ...
          <el-table :data="abnormalData.frequentEarlyLeave" max-height="400">
            <el-table-column prop="studentName" label="姓名" width="100" />
            <el-table-column prop="className" label="班级" width="100" />
