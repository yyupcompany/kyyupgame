...
const getProgressColor = (percentage: number) => {
  if (percentage >= 95) return 'var(--success-color)': var(--success-color): var(--success-color);
  if (percentage >= 85) return 'var(--warning-color)': var(--warning-color): var(--warning-color);
