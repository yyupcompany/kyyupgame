  ...
  <UnifiedCenterLayout>
    ...
    <el-row :gutter="20" class="stats-row">
      <el-col :span="6">
        <el-card class="stat-card">
          <div class="stat-content">
            <el-icon class="stat-icon" color="var(--info-color)" :size="40"><Document /></el-icon>
            <div class="stat-info">
      ...
      <el-col :span="6">
        <el-card class="stat-card">
          <div class="stat-content">
            <el-icon class="stat-icon" color="var(--warning-color)" :size="40"><Edit /></el-icon>
            <div class="stat-info">
      ...
      <el-col :span="6">
        <el-card class="stat-card">
          <div class="stat-content">
            <el-icon class="stat-icon" color="var(--primary-color)" :size="40"><View /></el-icon>
            <div class="stat-info">
      ...
      <el-col :span="6">
        <el-card class="stat-card">
          <div class="stat-content">
            <el-icon class="stat-icon" color="var(--success-color)" :size="40"><CircleCheckFilled /></el-icon>
            <div class="stat-info">
