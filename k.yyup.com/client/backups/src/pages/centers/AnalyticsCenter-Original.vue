    ...
    <div class="center-content">
      <div class="welcome-section">
        <div class="welcome-content">
          <h2>
            <el-icon style="margin-right: var(--spacing-sm);"><TrendCharts /></el-icon>
            欢迎来到数据分析中心
          </h2>
  ...
  .analytics-features {
    ...
    .feature-card {
      ...
      .feature-icon {
        ...
        &.success { background: linear-gradient(135deg, var(--success-color), #059669); color: white; }
        &.info { background: linear-gradient(135deg, #06b6d4, #0891b2); color: white; }
        &.warning { background: linear-gradient(135deg, var(--warning-color), #d97706); color: white; }
        &.danger { background: linear-gradient(135deg, var(--danger-color), #dc2626); color: white; }
      }
