      ...
      <el-col :span="8">
        ...
        <el-card class="shortcuts-card">
          ...
          <el-space direction="vertical" style="width: 100%">
            <el-button style="width: 100%" @click="handleInsertTable">
              <el-icon><Grid /></el-icon>
              插入表格
            </el-button>
            <el-button style="width: 100%" @click="handleInsertList">
              <el-icon><List /></el-icon>
              插入列表
            </el-button>
            <el-button style="width: 100%" @click="handleInsertImage">
              <el-icon><Picture /></el-icon>
              插入图片
            </el-button>
            <el-button style="width: 100%" @click="handleFormat">
