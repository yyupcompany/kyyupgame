    ...
    <el-tabs v-model="activeTab" class="content-tabs">
      ...
      <el-tab-pane label="测评配置" name="configs">
        <div class="table-container">
          <el-table :data="configs" v-loading="configsLoading" border>
      ...
      <el-tab-pane label="题目管理" name="questions">
        <div class="table-toolbar">
          ...
          <el-select v-model="questionFilter.dimension" placeholder="选择维度" clearable style="width: 150px">
        ...
        <div class="table-container">
          <el-table :data="questions" v-loading="questionsLoading" border>
            <el-table-column prop="id" label="ID" width="80" />
            ...
            <el-table-column label="配图" width="100">
              <template #default="{ row }">
                <el-image
                  ...
                  :src="row.imageUrl"
                  fit="cover"
                  style="width: 60px; height: 60px; border-radius: var(--spacing-xs);"
                  :preview-src-list="[row.imageUrl]"
                >
                  <template #error>
                    <div style="width: 60px; height: 60px; display: flex; align-items: center; justify-content: center; background: var(--bg-hover); border-radius: var(--spacing-xs);">
                      <el-icon><Picture /></el-icon>
                    </div>
                  </template>
                </el-image>
                <div v-else style="width: 60px; height: 60px; display: flex; align-items: center; justify-content: center; background: var(--bg-hover); border-radius: var(--spacing-xs); color: var(--text-placeholder);">
                  <el-icon><Picture /></el-icon>
                </div>
              </template>
            </el-table-column>
      ...
      <el-tab-pane label="体能训练项目" name="physical">
        ...
        <div class="table-container">
          <el-table :data="physicalItems" v-loading="physicalItemsLoading" border>
            <el-table-column prop="id" label="ID" width="80" />
          ...
          <div class="image-upload-container">
            <div v-if="questionForm.imageUrl" class="image-preview">
              <el-image
                ...
                fit="cover"
                style="width: 150px; height: 150px; border-radius: var(--spacing-xs);"
