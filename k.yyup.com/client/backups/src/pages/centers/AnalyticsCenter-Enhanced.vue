      ...
      <div class="visualization-content">
        <div class="visualization-header">
          ...
          <div class="header-controls">
            <el-select v-model="visualizationType" placeholder="选择图表类型" style="width: 150px">
            ...
            <el-date-picker
              ...
              style="width: 240px; margin-left: var(--text-sm)"
            />
            <el-button type="primary" @click="updateVisualization" style="margin-left: var(--text-sm)">
        ...
        <div class="charts-display">
          <div class="cds-grid">
            ...
            <div class="cds-row" style="margin-top: var(--text-2xl)">
              <div class="cds-col-lg-8 cds-col-md-8 cds-col-sm-4">
                <ChartContainer
                  title="财务数据分析"
                  subtitle="收入支出及利润情况"
            ...
            <div class="insight-content">
              ...
              <div class="insight-metrics">
                <div class="metric-item">
                  ...
                  <el-progress :percentage="insight.confidence" :stroke-width="6" />
                </div>
                <div class="metric-item">
...
const reportsColumns = ref([
  { prop: 'name', label: '报表名称', width: 200 },
  { prop: 'type', label: '类型', width: 100 },
  { prop: 'frequency', label: '频率', width: 100 },
  { prop: 'lastGenerated', label: '最后生成时间', width: 180 },
