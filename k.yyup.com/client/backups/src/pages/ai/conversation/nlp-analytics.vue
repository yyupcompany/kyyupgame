      ...
      <div class="metrics-grid">
        <div class="metric-card">
          ...
          <div class="metric-trend" :class="sentimentTrend">
            <el-icon><component :is="getTrendIcon(sentimentTrend)" /></el-icon>
            {{ sentimentChange }}%
          </div>
        </div>
        <div class="metric-card">
        ...
        <div class="metric-card">
          ...
          <div class="metric-trend" :class="responseTimeTrend">
            <el-icon><component :is="getTrendIcon(responseTimeTrend)" /></el-icon>
                  ...
                  <div class="conversation-header">
                    ...
                    <div class="conversation-metrics">
                      <div class="sentiment" :class="conversation.sentiment">
                        <el-icon><component :is="getSentimentIcon(conversation.sentiment)" /></el-icon>
                ...
                <div class="trend-insights">
                  <div class="insight" v-for="insight in topicTrendInsights" :key="insight.topic">
                    ...
                    <div class="insight-trend" :class="insight.trend">
                      <el-icon><component :is="getTrendIcon(insight.trend)" /></el-icon>
                      {{ insight.change }}%
                    </div>
                  </div>
                </div>
...
.stream-header {
  ...
  background: var(--bg-gray-light);
  border-bottom: var(--border-width-base) solid #e5e6eb;
