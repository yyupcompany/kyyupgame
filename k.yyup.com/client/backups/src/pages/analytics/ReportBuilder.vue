      ...
      <div class="tools-panel">
        ...
        <div class="tool-section">
          ...
          <div class="data-sources">
            ...
            >
              <el-icon class="source-icon"><Coin /></el-icon>
        ...
        <div class="tool-section">
          ...
          <div class="chart-types">
            ...
            >
              <el-icon class="chart-icon"><component :is="type.icon" /></el-icon>
                  ...
                  <div class="drop-zone metrics-zone">
                    ...
                    >
                      ...
                      >
                        ...
                        <el-select v-model="metric.aggregation" size="small" style="width: 80px;">
        ...
        <div class="preview-panel">
          ...
          <div class="preview-content" v-loading="previewLoading">
            <div v-if="!hasValidConfig" class="preview-empty">
              <el-icon class="empty-icon" :size="64"><DocumentAdd /></el-icon>
              <h4>开始构建您的报表</h4>
            ...
            <div v-else-if="previewData" class="preview-chart">
              ...
              <div v-if="reportConfig.chartType === 'table'" class="preview-table">
                <el-table :data="previewData.tableData || []" stripe style="width: 100%">
                  <el-table-column 
