              ...
              <div class="demographics">
                ...
                <div class="demo-charts">
                  <div class="demo-chart">
                    <h5>年龄分布</h5>
                    <div id="ageChart" style="width: 100%; height: 200px;"></div>
                  </div>
                  <div class="demo-chart">
                    <h5>收入水平</h5>
                    <div id="incomeChart" style="width: 100%; height: 200px;"></div>
                  </div>
                </div>
              </div>
    ...
    const option = {
      ...
      series: [
        ...
        },
        {
          ...
          type: 'line',
          data: applications,
          lineStyle: { color: 'var(--success-color)' },
        ...
        },
        {
          ...
          type: 'line',
          data: enrollments,
          lineStyle: { color: 'var(--warning-color)' },
