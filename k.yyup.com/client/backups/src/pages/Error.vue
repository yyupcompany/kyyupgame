    ...
    <div class="error-content">
      ...
      <div class="error-visual">
        <div class="error-icon">
          <el-icon v-if="errorType === 'network'" :size="80" color="#f56565">
            <Connection />
          </el-icon>
          <el-icon v-else-if="errorType === 'server'" :size="80" color="#ed8936">
            <Warning />
          </el-icon>
          <el-icon v-else-if="errorType === 'permission'" :size="80" color="#9f7aea">
            <Lock />
          </el-icon>
          <el-icon v-else :size="80" color="var(--danger-color)">
            <CircleClose />
          </el-icon>
        </div>
