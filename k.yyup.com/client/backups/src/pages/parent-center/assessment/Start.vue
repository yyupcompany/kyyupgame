...
.assessment-start-page {
  ...
  &::after {
    ...
    width: 400px;
    height: 400px;
    background: radial-gradient(circle, var(--white-alpha-8) 0%, transparent 70%);
    border-radius: var(--radius-full);
  ...
  @keyframes float {
    ...
    50% {
      transform: translateY(-var(--text-2xl)) rotate(10deg);
    }
  }
  ...
  .container {
    ...
    .header {
      ...
      text-shadow: 0 2px var(--spacing-xs) var(--black-alpha-10);
    ...
    .form-card {
      margin-bottom: var(--spacing-10xl);
      box-shadow: 0 10px 40px var(--black-alpha-15);
      border-radius: var(--text-lg);
      transition: transform 0.3s ease, box-shadow 0.3s ease;
      
      &:hover {
        transform: translateY(-5px);
        box-shadow: 0 15px 50px var(--black-alpha-20);
      }
