    ...
    >
      <div v-if="currentChild" class="child-detail">
        <div class="child-header">
          <el-avatar :size="64" :src="currentChild.avatar || defaultAvatar"></el-avatar>
        ...
        >
          ...
          <el-table-column prop="teacher" label="评价老师" width="100" />
          <el-table-column label="操作" width="100">
            <template #default="scope">
...
export default defineComponent({
  ...
  setup() {
    ...
    const handleViewGrowth = (child: Child) => {
      router.push(`/parent/child/growth/${child.id}`);
    };
