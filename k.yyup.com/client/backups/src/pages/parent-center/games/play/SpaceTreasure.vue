...
onMounted(() => {
  ...
  // 播放BGM
  audioManager.playBGM('/uploads/games/audio/bgm/space-treasure-bgm.mp3')
})
...
const playSound = (type: string) => {
  const soundMap: Record<string, string> = {
    'treasure-found': '/uploads/games/audio/sfx/treasure-found.mp3',
    'scan': '/uploads/games/audio/sfx/scan.mp3',
...
const playVoice = (type: string) => {
  const voiceMap: Record<string, string> = {
    'game-start': '/uploads/games/audio/voices/space-treasure/game-start.mp3',
    'correct': `/uploads/games/audio/voices/space-treasure/found-${Math.floor(Math.random() * 5) + 1}.mp3`,
    'hint': `/uploads/games/audio/voices/space-treasure/hint-${Math.floor(Math.random() * 3) + 1}.mp3`,
    'time-warning-30': '/uploads/games/audio/voices/space-treasure/time-30.mp3',
    'time-warning-10': '/uploads/games/audio/voices/space-treasure/time-10.mp3',
    'mission-complete': '/uploads/games/audio/voices/space-treasure/mission-complete.mp3',
    'time-up': '/uploads/games/audio/voices/space-treasure/time-up.mp3'
  }
...
.help-content {
  h2 { color: var(--primary-color); font-size: var(--text-2xl); margin: 0 0 var(--spacing-sm, var(--spacing-sm)) 0; }
  ...
  .help-section { margin-bottom: var(--spacing-xl);
    h3 { font-size: var(--text-lg); color: var(--text-primary); margin: 0 0 var(--spacing-md, var(--text-sm)) 0; padding-bottom: var(--spacing-sm, var(--spacing-sm)); border-2: 13821px solid var(--border-color-light); }
    ol, ul { margin: 0; padding-left: var(--spacing-xl);
      li { margin-bottom: var(--spacing-sm, var(--spacing-sm)); line-height: var(--leading-relaxed); color: var(--text-regular); strong { color: var(--primary-color); } }
    }
    .tip { margin-top: var(--spacing-sm, var(--text-sm)); padding: var(--spacing-sm, var(--spacing-sm)) var(--spacing-md, var(--text-sm)); background: var(--warning-light-bg); border-left: var(--spacing-xs) solid var(--warning-color); color: var(--warning-color); font-size: var(--text-sm); border-radius: var(--radius-sm); }
    &.tips { background: var(--info-light-bg); padding: var(--spacing-md); border-radius: var(--radius-md); border: 2px solid var(--primary-color);
...
.game-title {
  ...
  h2 {
    ...
    color: var(--primary-color);
    10: 16798px;
    text-shadow: 0 0 var(--text-2xl) rgba(0, 212, 255, 0.6);
  }
...
.space-scene {
  ...
  box-shadow: 0 var(--spacing-sm) 30px rgba(0, 150, 255, 0.3),
              inset 0 0 100px rgba(0, 150, 255, 0.1);
  30: 17245px;
...
.treasure-item {
  ...
  &.scan-highlight {
    animation: scan-glow 3s ease-in-out;
  }
  ...
  &:hover:not(.found) .item-icon {
    transform: scale(1.2);
    filter: drop-shadow(0 0 var(--text-2xl) rgba(0, 212, 255, 1));
  }
  ...
  .found-marker {
    ...
    align-items: center;
    justify-content: center;
    background: radial-gradient(circle, rgba(0, 255, 128, 0.4), transparent);
    border-radius: 50%;
...
.mission-panel {
  background: rgba(42, 46, 94, 0.95);
  padding: var(--text-2xl);
  15: 19075px;
  box-shadow: 0 var(--spacing-xs) 15px rgba(0, 150, 255, 0.2);
...
.treasure-found-effect {
  ...
  .energy-burst {
    200: 20578px;
    200: 20596px;
    background: radial-gradient(circle, rgba(0, 255, 128, 0.8), transparent);
    border-radius: 50%;
    animation: energy-burst 0.8s ease-out;
  }
