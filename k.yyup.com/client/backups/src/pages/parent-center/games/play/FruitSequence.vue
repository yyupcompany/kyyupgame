<template>
  <div class="fruit-sequence-game">
    ...
    <div class="game-container">
      ...
      <div class="game-content">
        ...
        <div class="fruits-container">
          ...
          >
            <img :src="`/uploads/games/images/items/fruits/${fruit}.png`" :alt="getFruitName(fruit)" />
      ...
      <div class="bottom-toolbar">
        ...
        <el-button @click="toggleSFX" circle size="large">
          <el-icon v-if="sfxEnabled"><Bell /></el-icon>
    ...
    <!-- 结果弹窗 -->
    <el-dialog v-model="showResults" title="🎉 游戏结果" width="600px" :close-on-click-modal="false">
...
const playDemo = async () => {
  ...
  // 播放语音
  await audioManager.playVoice('/uploads/games/audio/voices/fruit-demo-start.mp3')
  ...
  for (let i = 0; i < currentSequence.value.length; i++) {
    ...
    // 播放水果名称音效
    if (sfxEnabled.value) {
      audioManager.playSFX('fruit-highlight', '/uploads/games/audio/sfx/fruit-highlight.mp3', sfxVolume.value / 100)
    }
  ...
  await audioManager.playVoice('/uploads/games/audio/voices/your-turn.mp3')
}
...
const handleFruitClick = async (index: number) => {
  ...
  if (index === expectedIndex) {
    ...
    if (sfxEnabled.value) {
      audioManager.playSFX('correct', '/uploads/games/audio/sfx/correct.mp3', sfxVolume.value / 100)
    }
    ...
    if (sfxEnabled.value) {
      audioManager.playSFX('wrong', '/uploads/games/audio/sfx/wrong.mp3', sfxVolume.value / 100)
    }
    
    await audioManager.playVoice('/uploads/games/audio/voices/try-again.mp3')
...
const handleLevelComplete = async () => {
  ...
  if (sfxEnabled.value) {
    audioManager.playSFX('level-complete', '/uploads/games/audio/sfx/level-complete.mp3', sfxVolume.value / 100)
  }
  
  await audioManager.playVoice('/uploads/games/audio/voices/level-complete.mp3')
...
const handleGameOver = async () => {
  ...
  if (sfxEnabled.value) {
    audioManager.playSFX('gameover', '/uploads/games/audio/sfx/gameover.mp3', sfxVolume.value / 100)
  }
  
  await audioManager.playVoice('/uploads/games/audio/voices/gameover.mp3')
...
.fruit-sequence-game {
  ...
  .game-container {
    ...
    .top-bar {
      ...
      border-bottom: 3px solid var(--warning-color-transparent);
    ...
    .bottom-toolbar {
      ...
      border-top: 2px solid var(--warning-color-transparent);
