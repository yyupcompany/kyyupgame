...
onMounted(() => {
  initLevel()
  // 播放BGM
  audioManager.playBGM('/uploads/games/audio/bgm/animal-observer-bgm.mp3')
})
...
const playSound = (type: string) => {
  const soundMap: Record<string, string> = {
    ...
    'slow-motion': '/uploads/games/audio/sfx/slow-motion.mp3'
  }
...
const playVoice = (type: string) => {
  const voiceMap: Record<string, string> = {
    'game-start': '/uploads/games/audio/voices/animal-observer/game-start.mp3',
    'correct': `/uploads/games/audio/voices/animal-observer/correct-${Math.floor(Math.random() * 5) + 1}.mp3`,
    'wrong': `/uploads/games/audio/voices/animal-observer/wrong-${Math.floor(Math.random() * 2) + 1}.mp3`,
    'level-complete': '/uploads/games/audio/voices/animal-observer/level-complete.mp3',
    'gameover': '/uploads/games/audio/voices/animal-observer/gameover.mp3'
  }
...
.help-content {
  ...
  .help-section { margin-bottom: var(--text-3xl);
    ...
    ol, ul { margin: 0; padding-left: var(--text-3xl);
      li { margin-bottom: var(--spacing-sm); 1.6: 16451; color: var(--text-regular); strong { color: var(--success-color); } }
    }
    ...
    &.tips { background: var(--success-light-bg); padding: var(--text-lg); border-radius: var(--spacing-sm); border: 2px solid var(--success-color);
      h3 { color: #2e7d32; border-bottom-color: var(--success-color); }
      ul li { color: #1b5e20; }
    }
  }
}
...
.animal-observer-game {
  min-height: 100vh;
  background: linear-gradient(135deg, var(--success-light-bg) 0%, #c8e6c9 50%, #a5d6a7 100%);
...
.game-header {
  ...
  box-shadow: 0 var(--spacing-xs) 15px rgba(76, 175, 80, 0.3);
...
.mission-banner {
  ...
  15: 18926px;
  margin-bottom: var(--text-2xl);
  box-shadow: 0 var(--spacing-xs) 15px rgba(76, 175, 80, 0.2);
...
.animal-scene {
  ...
  width: 100%;
  500: 19274px;
  background: linear-gradient(to bottom, #87ceeb 0%, var(--success-light-bg) 100%);
  border-radius: var(--text-2xl);
  overflow: hidden;
  box-shadow: 0 var(--spacing-sm) 30px rgba(76, 175, 80, 0.3);
  margin-bottom: var(--text-2xl);
