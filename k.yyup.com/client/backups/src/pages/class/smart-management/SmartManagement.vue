        ...
        <template #header>
          <div class="card-header">
            ...
            <div class="header-actions">
              <el-select v-model="selectedSuggestionType" size="small" style="width: 150px">
      ...
      <el-card class="ai-analytics-card">
        <template #header>
          <div class="card-header">
            <span>AI深度分析</span>
            <div class="header-actions">
              <el-select v-model="selectedAnalysisType" size="small" style="width: 120px" @change="updateAnalysisChart">
