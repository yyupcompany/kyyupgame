      ...
      <el-tabs v-model="activeTab" @tab-change="handleTabChange">
        ...
        <el-tab-pane label="任教班级" name="classes">
          <div class="classes-section">
            ...
            <el-table :data="teachingClasses" style="width: 100%; min-height: 300px;">
        ...
        <el-tab-pane label="教学记录" name="teaching">
          <div class="teaching-section">
            ...
            <el-table :data="teachingRecords" style="width: 100%; min-height: 300px;">
        ...
        <el-tab-pane label="考勤记录" name="attendance">
          <div class="attendance-section">
            ...
            <el-table :data="attendanceRecords" style="width: 100%; min-height: 300px;">
              <el-table-column prop="date" label="日期" width="120">
                <template #default="scope">
                  {{ formatDate(scope.row.date) }}
                </template>
        ...
        <el-tab-pane label="绩效评估" name="performance">
          <div class="performance-section">
            ...
            <el-table :data="performanceRecords" style="width: 100%; min-height: 300px;">
