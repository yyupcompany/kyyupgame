      ...
      <el-card>
        <template #header>
          <div class="section-header">
            <span>客户转化漏斗</span>
            <el-select v-model="funnelPeriod" size="small" style="width: 120px">
      ...
      <el-card>
        ...
        <div class="trend-chart" ref="trendChartRef">
          <div class="chart-placeholder">
            <el-icon :size="48" color="var(--text-placeholder)": var(--text-placeholder): var(--text-placeholder)><TrendCharts /></el-icon>
            <p>客户数量趋势图表</p>
