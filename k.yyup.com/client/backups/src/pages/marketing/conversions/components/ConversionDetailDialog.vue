  ...
  >
    <div class="conversion-detail" v-loading="loading">
      <div v-if="item">
        ...
        <div class="detail-section">
          <h4>详细数据</h4>
          <el-table :data="detailTableData" size="small" style="width: 100%">
...
const loadDetailData = async () => {
  ...
  try {
    ...
    const res = await request.get('/marketing/stats/conversions/detail', params)
...
const loadTrendData = async () => {
  ...
  try {
    ...
    const res = await request.get('/marketing/stats/conversions/trend', params)
