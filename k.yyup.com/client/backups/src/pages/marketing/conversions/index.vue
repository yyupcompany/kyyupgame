  ...
  <div class="marketing-conversions page-container">
    <PageHeader title="转换统计">
      <template #actions>
        ...
        <el-select v-model="period" style="width: 120px; margin-right: var(--text-sm)" @change="loadData">
...
const loadData = async () => {
  ...
  try {
    ...
    const res = await request.get('/marketing/stats/conversions', params)
...
const exportData = async () => {
  try {
    ...
    const res = await request.get('/marketing/stats/conversions/export', params, { responseType: 'blob' })
