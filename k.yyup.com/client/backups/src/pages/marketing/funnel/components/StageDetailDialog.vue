      ...
      <div v-if="stage">
        ...
        <div class="detail-section">
          ...
          <div class="table-controls">
            ...
            <el-select v-model="statusFilter" placeholder="状态筛选" style="width: 120px; margin-right: var(--text-sm)">
          ...
          <el-table :data="filteredTableData" size="small" style="width: 100%" max-height="400">
...
const loadStageData = async () => {
  ...
  try {
    ...
    const res = await request.get('/marketing/stats/funnel/stage', params)
...
const loadTrendData = async () => {
  try {
    ...
    const res = await request.get('/marketing/stats/funnel/stage/trend', params)
...
const loadTableData = async () => {
  try {
    ...
    const res = await request.get('/marketing/stats/funnel/stage/users', params)
