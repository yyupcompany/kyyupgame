      ...
      <div v-if="item">
        ...
        <div class="detail-section">
          ...
          <div class="stages-detail">
            <el-table :data="stageDetails" style="width: 100%">
        ...
        <div class="detail-section">
          ...
          <div class="user-controls">
            ...
            <el-select v-model="stageFilter" placeholder="阶段筛选" style="width: 120px; margin-right: var(--text-sm)">
          ...
          <el-table :data="filteredUsers" size="small" style="width: 100%" max-height="300">
...
const loadDetailData = async () => {
  ...
  try {
    ...
    const res = await request.get('/marketing/stats/funnel/dimension/detail', params)
...
const loadTrendData = async () => {
  try {
    ...
    const res = await request.get('/marketing/stats/funnel/dimension/trend', params)
...
const loadUsers = async () => {
  try {
    ...
    const res = await request.get('/marketing/stats/funnel/dimension/users', params)
