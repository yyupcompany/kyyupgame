<template>
  <div class="marketing-channels page-container">
    ...
    <div class="app-card">
      <div class="search-section">
        <el-form :inline="true" :model="filters">
          ...
          <el-form-item label="渠道类型">
            <el-select v-model="filters.channelType" clearable placeholder="选择类型" style="width: 150px">
      ...
      <el-table :data="list" v-loading="loading" style="width:100%" @sort-change="handleSort">
...
const loadList = async () => {
  ...
  try {
    ...
    const res = await request.get('/marketing/channels', params)
...
const deleteChannel = async (row: any) => {
  try {
    ...
    await request.delete(`/marketing/channels/${row.id}`)
