      ...
      <div class="add-contact-section">
        <el-form :inline="true" :model="newContact" @submit.prevent="addContact">
          <el-form-item label="姓名">
            <el-input v-model="newContact.name" placeholder="联系人姓名" style="width: 120px" />
          </el-form-item>
          <el-form-item label="职位">
            <el-input v-model="newContact.position" placeholder="职位" style="width: 120px" />
          </el-form-item>
          <el-form-item label="电话">
            <el-input v-model="newContact.phone" placeholder="手机号码" style="width: 140px" />
          </el-form-item>
...
const loadContacts = async () => {
  ...
  loading.value = true
  try {
    const res = await request.get(`/marketing/channels/${props.channel.id}/contacts`)
...
const addContact = async () => {
  ...
  try {
    await request.post(`/marketing/channels/${props.channel.id}/contacts`, newContact)
...
const removeContact = async (contact: any) => {
  try {
    ...
    await request.delete(`/marketing/channels/${props.channel.id}/contacts/${contact.id}`)
