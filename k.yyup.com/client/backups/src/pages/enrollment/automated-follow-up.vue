      ...
      <el-card shadow="never">
          ...
          <div class="card-header">
            ...
            <div class="header-actions">
              ...
              <el-button @click="toggleAutomation" :type="automationEnabled ? 'danger' : 'success'">
                <el-icon><component :is="automationEnabled ? VideoPause : VideoPlay" /></el-icon>
        ...
        <div class="dashboard-stats">
          ...
          <div class="stat-card">
            ...
            <div class="stat-icon automation"><el-icon><Operation /></el-icon></div>
          </div>
          <div class="stat-card">
            <div class="stat-value">{{ avgResponseRate }}%</div>
            <div class="stat-label">平均响应率</div>
            <div class="stat-icon response"><el-icon><MessageBox /></el-icon></div>
          </div>
        </div>
      </el-card>
    </div>
        ...
        <template #header>
          <div class="card-header">
            ...
            <div class="header-controls">
              <el-select v-model="queueFilter" placeholder="筛选条件" style="width: 150px;">
        ...
        <div class="queue-timeline">
          ...
          >
            <div class="timeline-marker" :class="followUp.priority">
              <el-icon><component :is="getPriorityIcon(followUp.priority)" /></el-icon>
            </div>
                ...
                <div class="next-action">
                  <div class="action-info">
                    <div class="action-title">
                      <el-icon><component :is="getActionIcon(followUp.nextAction.type)" /></el-icon>
