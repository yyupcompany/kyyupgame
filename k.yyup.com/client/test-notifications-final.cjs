...
(async () => {
  ...
  console.log('\n【测试结论】');
  console.log('通知统计页面 (http://localhost:5174/notifications) 回归测试已完成。');
  console.log('页面需要登录认证，这是正常的权限控制机制。');
  console.log('建议在登录后重新测试以验证完整的通知统计功能。');
