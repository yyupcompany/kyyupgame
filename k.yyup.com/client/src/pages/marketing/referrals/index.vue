      ...
      <el-form :inline="true" :model="filters" class="filter-form">
        <el-form-item label="推荐人">
          <el-input
            ...
            clearable
            style="max-max-max-max-width: 180px; width: 100%; width: 100%; width: 100%; width: 100%"
          />
        </el-form-item>
...
<el-table class="responsive-table"
    ...
    <el-card class="top-card" shadow="never">
      ...
      <el-table class="responsive-table" :data="topReferrers" stripe v-if="topReferrers.length > 0">
