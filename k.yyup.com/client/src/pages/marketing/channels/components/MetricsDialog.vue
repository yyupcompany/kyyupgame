...
<el-table class="responsive-table" :data="historyData" size="small" style="width: 100%">
...
const loadMetrics = async () => {
  ...
  loading.value = true
  try {
    const res = await request.get(`/api/marketing/channels/${props.channel.id}/metrics`)
