...
<el-table class="responsive-table" :data="tagStats" size="small" style="width: 100%">
...
const loadCurrentTags = async () => {
  ...
  try {
    const res = await request.get(`/api/marketing/channels/${props.channel.id}/tags`)
...
const loadTagStats = async () => {
  try {
    const res = await request.get('/api/marketing/channels/tags/stats')
...
const addTags = async () => {
  ...
  try {
    await request.post(`/api/marketing/channels/${props.channel.id}/tags`, {
...
const removeTag = async (tag: any) => {
  try {
    ...
    await request.delete(`/api/marketing/channels/${props.channel.id}/tags/${tag.id}`)
