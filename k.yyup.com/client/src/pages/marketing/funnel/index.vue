...
import { getPrimaryColor, primaryRgba } from '@/utils/color-tokens'
...
const loadData = async () => {
  ...
  try {
    ...
    const res = await request.get('/api/marketing/stats/funnel', params)
...
const loadDimensionData = async () => {
  try {
    ...
    const res = await request.get('/api/marketing/stats/funnel/dimension', params)
...
const exportData = async () => {
  try {
    ...
    const res = await request.get('/api/marketing/stats/funnel/export', params, { responseType: 'blob' })
  ...
  .stages-container {
    .stages-flow {
      ...
      .stage-item {
        ...
        .stage-arrow {
          position: absolute;
          right: var(--position-negative-10xl);
          top: 50%;
