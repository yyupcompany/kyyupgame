...
<el-table class="responsive-table" :data="participationRanking" stripe>
          ...
          <el-tab-pane label="满意度排行" name="satisfaction">
            <el-table class="responsive-table" :data="satisfactionRanking" stripe>
              <el-table-column type="index" label="排名" width="80" />
              <el-table-column prop="title" label="活动名称" min-width="200" />
              <el-table-column prop="satisfactionScore" label="满意度" width="120">
                <template #default="{ row }">
          ...
          <el-tab-pane label="转化率排行" name="conversion">
            <el-table class="responsive-table" :data="conversionRanking" stripe>
              <el-table-column type="index" label="排名" width="80" />
              <el-table-column prop="title" label="活动名称" min-width="200" />
