          ...
          <template #template>
            <el-card>
              <div style="padding: var(--spacing-5xl);">
                <el-skeleton-item variant="text" style="width: 80%; min-height: 32px; height: auto; margin-bottom: var(--spacing-2xl);" />
          ...
          <el-card class="section-card">
            ...
            <div v-if="loading.tasks" class="loading-container">
              <el-skeleton :loading="loading.tasks" animated :count="4">
                <template #template>
                  <div style="margin-bottom: var(--spacing-lg); padding: var(--spacing-lg); border: var(--border-width-base) solid var(--border-color-lighter); border-radius: var(--radius-lg);">
                    <el-skeleton-item variant="text" style="width: 20%; min-height: 32px; height: auto; margin-bottom: var(--spacing-md);" />
                    <el-skeleton-item variant="text" style="width: 80%; height: var(--spacing-md); margin-bottom: var(--spacing-sm);" />
          ...
          <el-card class="section-card">
            ...
            <div v-if="loading.schedule" class="loading-container">
              <el-skeleton :loading="loading.schedule" animated :count="3">
                <template #template>
                  <div style="margin-bottom: var(--spacing-lg); padding: var(--spacing-lg); border: var(--border-width-base) solid var(--border-color-lighter); border-radius: var(--radius-lg);">
                    <el-skeleton-item variant="text" style="width: 30%; height: 1var(--spacing-sm); margin-bottom: var(--spacing-md);" />
                    <el-skeleton-item variant="text" style="width: 70%; height: var(--spacing-md); margin-bottom: var(--spacing-sm);" />
