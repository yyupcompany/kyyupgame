      ...
      <el-form :inline="true" :model="filterForm">
        ...
        <el-form-item label="学生" v-if="filterForm.type === 'student' && filterForm.classId">
          <el-select
            ...
            @change="loadHistory"
            clearable
            style="max-max-width: 150px; width: 100%; width: 100%"
          >
            <el-option
...
<el-table class="responsive-table" :data="teacherHistory" border stripe v-loading="loading">
    ...
    <el-card v-if="filterForm.type === 'student'" class="history-card" shadow="never">
      ...
      <el-table class="responsive-table" :data="studentHistory" border stripe v-loading="loading">
        <el-table-column type="index" label="序号" width="60" align="center" />
        <el-table-column prop="attendanceDate" label="日期" width="120" />
