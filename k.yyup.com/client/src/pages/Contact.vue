          ...
          <el-card shadow="never">
            ...
            <div class="address-list">
              <div class="address-item">
                <h4>总园区</h4>
                <p><UnifiedIcon name="default" /> 北京市朝阳区幸福街123号</p>
                <p><UnifiedIcon name="default" /> 010-12345678</p>
                <p><UnifiedIcon name="default" /> 周一至周五 7:30-18:00</p>
              </div>
              
              <div class="address-item">
                <h4>分园区A</h4>
                <p><UnifiedIcon name="default" /> 北京市海淀区快乐路456号</p>
                <p><UnifiedIcon name="default" /> 010-87654321</p>
                <p><UnifiedIcon name="default" /> 周一至周五 7:30-18:00</p>
              </div>
              
              <div class="address-item">
                <h4>分园区B</h4>
                <p><UnifiedIcon name="default" /> 北京市西城区童趣巷789号</p>
                <p><UnifiedIcon name="default" /> 010-11223344</p>
                <p><UnifiedIcon name="default" /> 周一至周五 7:30-18:00</p>
              </div>
            </div>
          </el-card>
          ...
          <el-card shadow="never">
            ...
            <div class="traffic-info">
              <div class="traffic-item">
                <h4><UnifiedIcon name="default" /> 公交路线</h4>
                <p>乘坐1路、15路、32路公交车至幸福街站下车，步行3分钟即到</p>
              </div>
              
              <div class="traffic-item">
                <h4><UnifiedIcon name="default" /> 地铁路线</h4>
                <p>地铁2号线至幸福站A出口，步行8分钟即到</p>
              </div>
              
              <div class="traffic-item">
                <h4><UnifiedIcon name="default" /> 自驾路线</h4>
                <p>导航至"幸福街123号"，园区提供免费停车位</p>
              </div>
              
              <div class="traffic-item">
                <h4><UnifiedIcon name="default" /> 周边标志</h4>
