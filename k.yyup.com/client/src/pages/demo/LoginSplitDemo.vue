...
.brand { max-width: 100%; max-width: 520px; }
.logo { width: auto; min-height: 60px; height: auto; border-radius: var(--text-lg); display: grid; place-items: center; font-size: var(--text-4xl); background: var(--white-alpha-15); box-shadow: 0 10px 30px var(--black-alpha-20); backdrop-filter: blur(6px); }
...
.features li span { width: auto; text-align: center; }

.card { width: 100%; max-width: 100%; max-width: 420px; padding: var(--spacing-7xl); border-radius: var(--text-lg); background: var(--bg-white); box-shadow: 0 var(--text-2xl) 60px rgba(0,0,0,0.12); }
...
.btn:hover { transform: translateY(var(--transform-hover-lift)); box-shadow: 0 var(--text-lg) 2var(--spacing-sm) rgba(102,126,234,.45); }
