      ...
      <el-card class="overview-card">
        <template #header>
          <div class="card-header">
            <span>评估概览</span>
            <el-select v-model="selectedPeriod" size="small" style="max-max-width: 120px; width: 100%; width: 100%" @change="handlePeriodChange">
...
import { getSuccessColor, getWarningColor } from '@/utils/color-tokens'
