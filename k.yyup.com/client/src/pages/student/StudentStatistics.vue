...
<el-table class="responsive-table" :data="statusTableData" style="width: 100%">
    ...
    <div class="trend-analysis">
      <el-card>
        <template #header>
          <div class="chart-header">
            <span>学生数量趋势</span>
            <el-select v-model="trendPeriod" size="small" style="max-width: 120px; width: 100%">
