              ...
              <el-card class="vos-panel">
                ...
                <div class="vos-info">
                  ...
                  <div class="info-item">
                    ...
                    <div class="info-value">
                      <el-select
                        ...
                        :disabled="!availableCallerNumbers || availableCallerNumbers.length === 0"
                      >
                        <el-option
                  ...
                  <div class="info-item">
                    ...
                    <div class="info-value">
                      <el-select
                        ...
                        :disabled="!availableExtensions || availableExtensions.length === 0"
                      >
                        <el-option
                  ...
                  <div class="info-item">
                    ...
                    <span class="info-value">{{ (activeCallCount || 0) }} / {{ (maxConcurrentCalls || 5) }}</span>
                  </div>
                </div>
              </el-card>
          ...
          <el-row :gutter="20">
            ...
            <el-col :xs="24" :md="12">
              <el-card>
                ...
                <el-form :model="vosConfigForm" label-width="120px">
                  <el-form-item label="主叫号码">
                    <el-input v-model="vosConfigForm.callerNumber" placeholder="输入主叫号码" />
                  </el-form-item>
                  <el-form-item label="服务器地址">
                    <el-input v-model="vosConfigForm.serverHost" placeholder="输入VOS服务器地址" />
                  </el-form-item>
                  <el-form-item label="服务器端口">
                    <el-input-number v-model="vosConfigForm.serverPort" :min="1" :max="65535" />
                  </el-form-item>
                  <el-form-item label="协议">
                    <el-select v-model="vosConfigForm.protocol">
...
// VOS配置表单数据（本地副本，避免直接绑定可能为null的vosConfig）
...
const handleCall = async (data: any) => {
  try {
    ...
    if (response.data?.callId) {
      ...
      updateCallStatus(currentCallCount + 1) // 使用配置服务更新状态
...
const handleHangup = async (callId: string) => {
  try {
    ...
    const currentCallCount = activeCallCount.value || 0
    updateCallStatus(Math.max(0, currentCallCount - 1)) // 使用配置服务更新状态
