      ...
      <div class="reports-content">
        <div class="section-header">
          ...
          <div class="header-actions">
            <el-select v-model="reportTimeRange" placeholder="选择时间范围" class="time-range-select">
...
<el-table class="responsive-table" :data="reportsList" v-loading="reportsLoading">
...
// 标签页配置
const tabs = [
  { key: 'overview', label: '概览', icon: 'data-analysis' },
  { key: 'payments', label: '收费管理', icon: 'finance' },
