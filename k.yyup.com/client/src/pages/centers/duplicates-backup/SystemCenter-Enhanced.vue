...
<el-table class="responsive-table" :data="users" stripe>
    ...
    <template #tab-backup>
      <div class="backup-content">
        ...
        <div class="backup-list">
          <el-table class="responsive-table" :data="backups" stripe>
    ...
    <template #tab-logs>
      <div class="logs-content">
        ...
        <!-- 日志列表 -->
        <div class="logs-list">
          <el-table class="responsive-table" :data="systemLogs" stripe max-height="600">
...
.overview-content {
  ...
  .stat-card {
    ...
    &:nth-child(2) {
      background: linear-gradient(135deg, var(--el-color-warning) 0%, var(--el-color-danger) 100%);
    }

    &:nth-child(3) {
      background: linear-gradient(135deg, var(--el-text-color-secondary) 0%, var(--el-text-color-regular) 100%);
    }
