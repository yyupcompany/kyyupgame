...
<el-table class="responsive-table" :data="learningRecords" style="width: 100%">
        ...
        <el-tab-pane label="考勤记录" name="attendance">
          <div class="attendance-section">
            ...
            <el-table class="responsive-table" :data="attendanceRecords" style="width: 100%">
              <el-table-column prop="date" label="日期" width="120">
                <template #default="scope">
                  {{ formatDate(scope.row.date) }}
                </template>
        ...
        <el-tab-pane label="健康档案" name="health">
          <div class="health-section">
            ...
            <el-table class="responsive-table" :data="healthRecords" style="width: 100%">
        ...
        <el-tab-pane label="家长沟通" name="communication">
          <div class="communication-section">
            ...
            <el-table class="responsive-table" :data="communicationRecords" style="width: 100%">
