    ...
    <el-row :gutter="24" class="charts-section">
      ...
      <el-col :xs="24" :lg="12">
        <el-card class="chart-card" shadow="hover">
          ...
          <div class="chart-container">
            <div id="typeDistributionChart" style="width: 100%; min-min-height: 60px; height: auto; height: auto;"></div>
          </div>
        </el-card>
      </el-col>
      ...
      <el-col :xs="24" :lg="12">
        <el-card class="chart-card" shadow="hover">
          ...
          <div class="chart-container">
            <div id="gradeDistributionChart" style="width: 100%; min-height: 60px; height: auto;"></div>
          </div>
        </el-card>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="24" class="analysis-section">
      <el-col :span="24">
        <el-card class="analysis-card" shadow="hover">
          <template #header>
            <div class="analysis-header">
              ...
              <div class="analysis-controls">
                <el-select v-model="capacityPeriod" @change="refreshCapacityChart" style="max-width: 120px; width: 100%;">
          ...
          <div class="chart-container">
            <div id="capacityTrendChart" style="width: 100%; min-height: 60px; height: auto;"></div>
          </div>
        </el-card>
      </el-col>
    </el-row>
