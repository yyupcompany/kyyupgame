    ...
    <el-card class="filter-card">
      <el-form :inline="true" :model="filters">
        <el-form-item label="发票号码">
          <el-input v-model="filters.invoiceNumber" placeholder="输入发票号码" clearable style="max-max-width: 200px; width: 100%; width: 100%" />
        </el-form-item>
        <el-form-item label="客户名称">
          <el-input v-model="filters.customerName" placeholder="输入客户名称" clearable style="width: 200px" />
        </el-form-item>
        <el-form-item label="发票类型">
          <el-select v-model="filters.invoiceType" placeholder="选择类型" clearable style="max-max-width: 150px; width: 100%; width: 100%">
