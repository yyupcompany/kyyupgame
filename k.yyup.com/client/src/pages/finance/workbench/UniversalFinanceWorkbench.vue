...
<el-table class="responsive-table" :data="todayPayments" stripe>
    ...
    <template #tab-reports>
      <div class="reports-content">
        ...
        <div class="reports-list">
          <el-table class="responsive-table" :data="financeReports" stripe>
          ...
          <el-tabs v-model="activeSettingsTab" type="card">
            <el-tab-pane label="收费项目配置" name="feeItems">
              <div class="settings-form">
                ...
                <!-- 收费项目列表 -->
                <el-table class="responsive-table" :data="feeItems" stripe>
            ...
            <el-tab-pane label="优惠政策配置" name="discounts">
              <div class="settings-form">
                ...
                <!-- 优惠政策列表 -->
                <el-table class="responsive-table" :data="discountPolicies" stripe>
