<template>
  <div class="assessment-report-page" ref="reportRef">
    ...
    <!-- 预约体验课对话框 -->
    <el-dialog v-model="bookDialogVisible" title="预约体验课" width="var(--container-sm)">
      <el-form :model="bookForm" label-width="var(--spacing-2xl)">
    ...
    <!-- 咨询园所对话框 -->
    <el-dialog v-model="consultDialogVisible" title="咨询园所" width="var(--container-sm)">
      <el-form :model="consultForm" label-width="var(--spacing-2xl)">
        <el-form-item label="家长姓名" required>
  ...
  const option = {
    ...
    series: [{
      ...
      data: [{
        ...
        name: '得分',
        areaStyle: {
          color: 'rgba(var(--primary-color-rgb, 64, 158, 255), 0.3)'
        },
        lineStyle: {
