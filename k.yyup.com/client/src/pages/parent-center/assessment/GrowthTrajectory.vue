  ...
  <div class="growth-trajectory-page">
    ...
    <div v-else class="trajectory-content">
      ...
      <el-card class="chart-card">
        ...
        <div ref="dqChartRef" class="chart-container" style="height: var(--spacing-4xl);"></div>
      </el-card>
      ...
      <el-card class="chart-card">
        ...
        <div ref="dimensionChartRef" class="chart-container" style="height: var(--spacing-5xl);"></div>
      </el-card>
...
<el-table class="responsive-table" :data="trajectoryData.records" style="width: 100%">
    ...
    series: [
      {
        ...
        areaStyle: {
          color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
            {
              offset: 0,
              color: 'rgba(var(--primary-color-rgb, 64, 158, 255), 0.5)'
            },
            {
              offset: 1,
              color: 'rgba(var(--primary-color-rgb, 64, 158, 255), 0.1)'
            }
          ])
        },
        markPoint: {
