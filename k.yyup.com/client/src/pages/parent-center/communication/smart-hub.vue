...
.suggestion-item {
  ...
  padding: var(--spacing-lg);
  border-radius: var(--radius-md);
  border: var(--border-width-base, 1px) solid var(--el-border-color-lighter);
}
...
.analysis-grid {
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(var(--spacing-3xl), 1fr));
  gap: var(--spacing-lg);
}
