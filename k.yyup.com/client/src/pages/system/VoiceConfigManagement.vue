      ...
      >
        ...
        <template v-if="formData.configType === 'vos'">
          <el-divider content-position="left">
            <UnifiedIcon name="default" /> VOS配置
          </el-divider>
        ...
        <template v-if="formData.configType === 'sip'">
          <el-divider content-position="left">
            <UnifiedIcon name="default" /> SIP配置
          </el-divider>
        ...
        <!-- DID号码配置 -->
        <el-divider content-position="left">
          <UnifiedIcon name="default" /> DID号码配置
        </el-divider>
    ...
    >
      <div v-if="viewingConfig">
        ...
        <div v-if="viewingConfig.summary?.didCount > 0" style="margin-top: var(--text-2xl);">
          <h4>DID号码列表</h4>
          <el-table class="responsive-table" :data="viewingConfig.summary.didNumbers" size="small">
