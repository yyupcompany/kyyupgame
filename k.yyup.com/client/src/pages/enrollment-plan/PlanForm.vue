...
<el-table class="responsive-table" :data="planForm.ageGroups" style="width: 100%">
        ...
        <div v-show="currentStep === 2" class="step-content">
          ...
          <el-form-item label="宣传渠道">
            <el-table class="responsive-table" :data="planForm.channels" style="width: 100%">
        ...
        <div v-show="currentStep === 3" class="step-content">
          ...
          <el-form-item label="关键节点">
            <el-table class="responsive-table" :data="planForm.milestones" style="width: 100%">
