...
<el-table class="responsive-table" :data="parentInfo.children" style="width: 100%" border>
        ...
        <div class="available-activities-section">
          ...
          <div class="filter-section">
            ...
            <el-select v-model="activityType" placeholder="活动类型" style="max-width: 150px; width: 100%" @change="handleSearch">
        ...
        <div v-if="selectedActivities.length > 0" class="selected-activities">
          ...
          <el-table class="responsive-table" :data="selectedActivities" style="width: 100%" border>
            <el-table-column prop="title" label="活动名称" min-width="200" />
            <el-table-column prop="time" label="活动时间" width="180" />
            <el-table-column prop="location" label="活动地点" width="150" />
            <el-table-column label="操作" width="120">
...
.selected-activities {
  ...
  border-top: var(--z-index-dropdown) dashed var(--border-color);
}
