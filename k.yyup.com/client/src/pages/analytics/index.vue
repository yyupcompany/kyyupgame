...
<el-table class="responsive-table" :data="recentEnrollments" style="width: 100%" stripe>
        ...
        <el-col :span="12">
          <el-card class="table-card">
            ...
            <el-table class="responsive-table" :data="popularActivities" style="width: 100%" stripe>
...
import { getSuccessColor, getDangerColor } from '@/utils/color-tokens'
  ...
  const option = {
    ...
    series: [
      ...
      },
      {
        ...
        type: 'bar',
        data: data.expense,
        itemStyle: { color: getDangerColor() }
      }
    ]
  }
