  ...
  >
    <template #header-actions>
      <el-date-picker
        ...
        style="width: 100%; max-width: 100%; max-width: 300px"
      />
...
<el-table class="responsive-table full-width-table"
    ...
    >
      <div v-if="currentUserDetail" class="user-detail">
        <h4>按类型统计</h4>
        <el-table class="responsive-table" :data="currentUserDetail.usageByType" stripe border :show-overflow-tooltip="true">
        ...
        <el-table class="responsive-table" :data="currentUserDetail.usageByModel" stripe border :show-overflow-tooltip="true">
        ...
        <el-table class="responsive-table" :data="currentUserDetail.recentUsage" stripe border :show-overflow-tooltip="true">
    ...
    >
      ...
      <div v-else-if="warnings.length > 0" class="warnings-content">
        ...
        <el-table class="responsive-table" :data="warnings" stripe border :show-overflow-tooltip="true">
