  ...
  <div class="draggable-resizable-qr" ref="containerRef">
    ...
    <div class="qr-controls" v-if="showControls">
      ...
      <div class="control-group">
        <label>标签文字：</label>
        <el-input v-model="qrLabel" size="small" style="max-width: 120px; width: 100%;" />
      </div>
...
.draggable-resizable-qr {
  ...
  .draggable-qr-container {
    ...
    &.dragging {
      ...
      box-shadow: 0 var(--spacing-xs) var(--spacing-xl) rgba(64, 158, 255, 0.4) !important;
      cursor: grabbing !important;
    }

    &.resizing {
      border-color: var(--success-color) !important;
      box-shadow: 0 var(--spacing-xs) var(--spacing-xl) rgba(103, 194, 58, 0.4) !important;
    ...
    .scale-control {
      position: absolute;
      bottom: var(--position-negative-10xl);
      left: 0;
      right: 0;
      display: flex;
      align-items: center;
  ...
  .qr-controls {
    ...
    min-max-width: 280px; width: 100%;
    max-width: 100%; max-width: 320px;
    z-index: var(--position-5xl);
