...
<el-table class="responsive-table" :data="comparisonTable.willImport" stripe>
      ...
      <div class="table-section" v-if="comparisonTable.willIgnore.length > 0">
        ...
        <el-table class="responsive-table" :data="comparisonTable.willIgnore" stripe>
          <el-table-column prop="sourceField" label="文档字段" width="150" />
      ...
      <div class="table-section" v-if="comparisonTable.conflicts.length > 0">
        ...
        <el-table class="responsive-table" :data="comparisonTable.conflicts" stripe>
          <el-table-column prop="sourceField" label="文档字段" width="150" />
      ...
      <div class="table-section" v-if="comparisonTable.missing.length > 0">
        ...
        <el-table class="responsive-table" :data="comparisonTable.missing" stripe>
