<template>
  ...
  >
    <div v-if="recording" class="recording-content">
      ...
      <div class="audio-player">
          ...
          <div class="player-controls">
            <el-button-group>
              <el-button size="small" @click="handlePlay">
                <UnifiedIcon :name="isPlaying ? 'Pause' : 'Play'" :size="14" />
                {{ isPlaying ? '暂停' : '播放' }}
              </el-button>
              <el-button size="small" @click="handleStop">
                <UnifiedIcon name="Square" :size="14" />
                停止
              </el-button>
        ...
        <div class="volume-control">
          <UnifiedIcon name="Volume2" :size="16" />
          <el-slider
            v-model="volume"
            :max="100"
            style="max-width: 120px; width: 100%; margin: 0 var(--text-sm)"
        ...
        <div class="speed-control">
          ...
          <el-select v-model="playbackRate" size="small" style="max-width: 100px; width: 100%" @change="handleSpeedChange">
    ...
    <div v-else class="no-recording">
      <UnifiedIcon name="FileAudio" :size="48" />
      <p>暂无录音信息</p>
    </div>
