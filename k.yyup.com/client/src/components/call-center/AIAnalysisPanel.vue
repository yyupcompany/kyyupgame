    ...
    <div class="voice-synthesis-card">
      ...
      <div class="synthesis-controls">
        <div class="model-selection">
          <label>语音模型:</label>
          <el-select v-model="selectedModel" size="small" style="max-width: 120px; width: 100%">
      ...
      <div class="text-input-area">
        ...
        <div class="synthesis-actions">
          ...
          >
            <UnifiedIcon name="Volume2" :size="14" />
            播放
          </el-button>
        </div>
      </div>
    ...
    <div class="script-generation-card">
      ...
      <div class="script-controls">
        ...
        <div class="script-actions">
          ...
          >
            <UnifiedIcon name="Sparkles" :size="14" />
            生成话术
          </el-button>
        </div>
      </div>
      <div v-if="generatedScript" class="generated-script">
        ...
        <div class="script-actions">
          <el-button size="small" @click="handleCopyScript">
            <UnifiedIcon name="Copy" :size="12" />
            复制
          </el-button>
          <el-button size="small" @click="handleUseScript">
            <UnifiedIcon name="Check" :size="12" />
            使用此话术
          </el-button>
        </div>
      </div>
    ...
    <div class="compliance-card">
      ...
      <div class="compliance-controls">
        ...
        <div class="compliance-actions">
          ...
          >
            <UnifiedIcon name="security" :size="14" />
            审查内容
          </el-button>
        </div>
      </div>
    ...
    <div class="transcription-card">
      ...
      <div class="transcription-actions">
        <el-button size="small" @click="handleClearTranscription">
          <UnifiedIcon name="Trash2" :size="12" />
          清空
        </el-button>
    ...
    <div v-if="callAnalysis" class="analysis-card">
      <div class="analysis-header">
        ...
        <el-button size="small" @click="handleRefreshAnalysis">
          <UnifiedIcon name="RefreshCw" :size="12" />
          刷新
        </el-button>
      </div>
    ...
    <div class="ai-assistant-card">
      ...
      <div class="quick-actions">
        ...
        <div class="action-button" @click="handleSentimentAnalysis">
          <UnifiedIcon name="Heart" :size="16" />
          <span>情感分析</span>
        </div>
      </div>
    </div>
