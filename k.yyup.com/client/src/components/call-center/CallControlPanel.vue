    ...
    <div v-if="currentCall" class="current-call-card">
      ...
      <div class="call-details">
        ...
        <div v-if="currentCall.recording" class="recording-indicator">
          <UnifiedIcon name="Circle" :size="12" class="recording-dot" />
          录音中
        </div>
      </div>
      ...
      <div class="call-controls">
        <el-button-group>
          ...
          >
            <UnifiedIcon name="Pause" :size="14" />
            保持
          </el-button>
          <el-button
          ...
          >
            <UnifiedIcon name="PhoneForwarded" :size="14" />
            转移
          </el-button>
          <el-button
            type="danger"
          ...
          >
            <UnifiedIcon name="PhoneOff" :size="14" />
            挂断
          </el-button>
        </el-button-group>
      </div>
