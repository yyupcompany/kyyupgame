          ...
          <el-tab-pane label="联系人" name="contacts">
            <div class="contacts-section">
              ...
              <div v-if="filteredContacts.length === 0" class="no-contacts">
                <UnifiedIcon name="user-group" :size="48" />
                <p>暂无联系人</p>
              </div>
            </div>
          </el-tab-pane>
          ...
          <el-tab-pane label="通话记录" name="history">
            <div class="call-history-section">
              <div class="history-filters">
                <el-select v-model="historyFilter" size="small" style="max-width: 120px; width: 100%">
                ...
                >
                  ...
                  <div class="history-action">
                    <el-button size="small" type="primary" circle>
                      <UnifiedIcon name="phone" :size="12" />
                    </el-button>
                  </div>
                </div>
              </div>
              ...
              <div v-if="filteredHistory.length === 0" class="no-history">
                <UnifiedIcon name="PhoneCall" :size="48" />
                <p>暂无通话记录</p>
              </div>
            </div>
          </el-tab-pane>
...
.make-call-content {
  ...
  .call-history-section {
    ...
    .history-item {
      ...
      border-bottom: var(--z-index-dropdown) solid var(--border-primary, var(--border-color));
      cursor: pointer;
...
.dialer-keypad {
  ...
  border-top: var(--z-index-dropdown) solid var(--border-primary, var(--border-color));
