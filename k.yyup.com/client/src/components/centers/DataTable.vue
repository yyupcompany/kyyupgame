...
.data-table {
  ...
  width: 100%; // 确保占满宽度
  overflow: hidden; text-overflow: ellipsis; white-space: nowrap; text-overflow: ellipsis; white-space: nowrap; text-overflow: ellipsis; white-space: nowrap; // 防止内容溢出
}
  ...
  @media (max-width: var(--breakpoint-xl)) {
    .table-toolbar {
      ...
      .toolbar-right {
        ...
        .el-input {
          max-width: 200px; width: 100% !important;
        }
      }
    }
  }
