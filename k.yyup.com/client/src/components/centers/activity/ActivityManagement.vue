    ...
    <div class="filters">
      <el-form :model="searchForm" inline>
        <el-form-item label="活动类型">
          <el-select v-model="searchForm.type" placeholder="选择类型" clearable :loading="activityTypeLoading">
            <el-option
        ...
        <el-form-item label="活动状态">
          <el-select v-model="searchForm.status" placeholder="选择状态" clearable :loading="activityStatusLoading">
            <el-option
        ...
        <template #coverImage="{ row }">
          <div class="cover-image">
            <el-image
              ...
              fit="cover"
              style="width: auto; height: var(--button-height-lg); border-radius: var(--spacing-xs);"
...
import { ACTIVITY_ENDPOINTS } from '@/api/endpoints/hardcoded-data-replacements'
