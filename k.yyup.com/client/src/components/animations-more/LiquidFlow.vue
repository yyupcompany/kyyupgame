  ...
  <div v-if="show" class="liquid-flow-container">
    ...
    <div class="main-content">
      ...
      <div class="text-content">
        <h1 ref="titleElement" class="flow-title">{{ getDynamicTitle() }}</h1>
        <p ref="subtitleElement" class="flow-subtitle">{{ getDynamicSubtitle() }}</p>
...
const getDynamicTitle = () => {
  ...
  return `${roleDisplayName}流体系统启动`
}

const getDynamicSubtitle = () => {
  if (props.subtitle) return props.subtitle
  return '正在为您构建流畅无缝的管理体验'
}
