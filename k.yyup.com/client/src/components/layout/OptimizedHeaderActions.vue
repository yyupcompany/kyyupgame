...
.header-action-btn {
  ...
  &.dashboard-btn {
    ...
    &:hover {
      ...
      box-shadow: 0 var(--spacing-xs) var(--spacing-sm) rgba(64, 158, 255, 0.4);
    }
  }
  ...
  &.ai-assistant-btn {
    ...
    &:hover {
      background: linear-gradient(135deg, var(--primary-hover) 0%, var(--primary-color) 100%);
      transform: translateY(var(--z-index-below));
      box-shadow: 0 var(--spacing-xs) var(--spacing-sm) rgba(102, 126, 234, 0.4);
    }
  }
}
...
.ai-badge {
  position: absolute;
  top: var(--transform-hover-lift);
  right: var(--transform-hover-lift);
