...
<el-table class="responsive-table" :data="preview?.fieldMappings || []" stripe size="small" max-height="300">
      ...
      <div class="section">
        <h3>🔍 数据预览（前5条）</h3>
        <el-table class="responsive-table" :data="preview?.preview || []" stripe size="small" max-height="300">
          <el-table-column
