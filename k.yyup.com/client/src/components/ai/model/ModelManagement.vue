  ...
  <div class="model-management">
    <el-row :gutter="20" class="header-row">
      ...
      <el-col :span="12" class="header-actions">
        <el-button type="primary" @click="showAddModelDialog">
          <UnifiedIcon name="Plus" />添加模型
        </el-button>
        <el-button @click="refreshModels">
          <UnifiedIcon name="Refresh" />刷新
        </el-button>
      </el-col>
    </el-row>
    ...
    <el-card class="model-list-card" v-loading="loading">
      <div class="table-wrapper">
        <el-table :data="models" class="responsive-table full-width">
    ...
    >
      ...
      >
        ...
        <el-form-item label="提供商" prop="provider">
          <el-select v-model="currentModel.provider" placeholder="选择提供商" class="full-width">
        ...
        <el-form-item label="模型类型" prop="modelType">
          <el-select v-model="currentModel.modelType" placeholder="选择模型类型" class="full-width">
