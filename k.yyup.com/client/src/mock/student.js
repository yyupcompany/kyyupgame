...
/**
 * getStudentList 的模拟数据
 */
export const getStudentListMock = 7;

/**
 * getStudentDetail 的模拟数据
 */
export const getStudentDetailMock = {
      "code": 200,
      "message": "success",
      "data": {}
    };
...
export const mockResponse = (apiName, params = {}) => {
  ...
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      switch (apiName) {
        case 'getStudentList':
          resolve(getStudentListMock);
          break;
        case 'getStudentDetail':
          resolve(getStudentDetailMock);
          break;
        default:
          resolve({
            code: 404,
