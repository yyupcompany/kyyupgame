<template>
  <div v-if="show" class="cube-explosion-container">
    ...
    <div class="info-panel">
      <h1 ref="titleElement" class="explosion-title">{{ title }}</h1>
      <p ref="subtitleElement" class="explosion-subtitle">{{ subtitle }}</p>
...
const initMainCubes = () => {
  ...
  mainCubes.value = props.modules.map((module, index) => ({
    ...module,
    assembled: false,
    position: {
