...
import GameComponent from '@/pages/parent-center/assessment/components/GameComponent'
...
describe('GameComponent - 完整测试覆盖', () => {
  ...
  describe('基础渲染测试', () => {
    ...
    it('应该包含必要的DOM结构', () => {
      // 根据实际组件结构添加断言
      expect(wrapper.find('.gamecomponent').exists()).toBe(true)
    })
  })
