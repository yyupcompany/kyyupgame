...
import FullPageSidebar from '@/components/ai-assistant/layout/full-page/FullPageSidebar'
...
describe('FullPageSidebar - 完整测试覆盖', () => {
  let wrapper: any
  ...
  describe('基础渲染测试', () => {
    ...
    it('应该包含必要的DOM结构', () => {
      // 根据实际组件结构添加断言
      expect(wrapper.find('.fullpagesidebar').exists()).toBe(true)
    })
  })
